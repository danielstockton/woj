(module
  ...
  ;; first: get the first element of a cons cell
  (func $first (param $cell anyref) (result anyref)
    (struct.get $Cons $first (ref.cast (ref $Cons) (local.get $cell))))

  ;; rest: get the rest of a cons cell
  (func $rest (param $cell anyref) (result anyref)
    (struct.get $Cons $rest (ref.cast (ref $Cons) (local.get $cell))))
  ...
  (global $width (mut anyref) (ref.null none))
  (global $height (mut anyref) (ref.null none))
  (global $paddle_height (mut anyref) (ref.null none))
  (global $paddle_width (mut anyref) (ref.null none))
  (global $ball_size (mut anyref) (ref.null none))
  (global $ball_speed (mut anyref) (ref.null none))
  (global $paddle_speed (mut anyref) (ref.null none))
  (global $half_paddle (mut anyref) (ref.null none))
  (global $half_ball (mut anyref) (ref.null none))
  (global $initial_state (mut anyref) (ref.null none))
  (global $state (mut anyref) (ref.null none))
  (global $__builtin__STAR_ (mut anyref) (ref.null none))

  ;; Closure function declarations
  (elem declare func $closure1 $closure2 $closure3 $closure4 $closure5 $closure6 $closure7 $closure8 $closure9 $fn10 $closure11 $closure12 $closure13 $closure14 $closure15 $fn16 $__builtin__STAR__fn)
  ...
  (func $clamp_internal (param $val anyref) (param $minv anyref) (param $maxv anyref) (result anyref)
    (if (result anyref)
      (call $truthy (ref.i31 (i32.lt_s (i31.get_s (ref.cast (ref i31) (local.get $val))) (i31.get_s (ref.cast (ref i31) (local.get $minv))))))
      (then (local.get $minv))
      (else (if (result anyref)
      (call $truthy (ref.i31 (i32.gt_s (i31.get_s (ref.cast (ref i31) (local.get $val))) (i31.get_s (ref.cast (ref i31) (local.get $maxv))))))
      (then (local.get $maxv))
      (else (local.get $val))))))

  (func $clamp (export "clamp") (param $val i32) (param $minv i32) (param $maxv i32) (result i32)
    (i31.get_s (ref.cast (ref i31) (call $clamp_internal (ref.i31 (local.get $val)) (ref.i31 (local.get $minv)) (ref.i31 (local.get $maxv))))))

  (func $negate_internal (param $x anyref) (result anyref)
    (ref.i31 (i32.sub (i31.get_s (ref.cast (ref i31) (ref.i31 (i32.const 0)))) (i31.get_s (ref.cast (ref i31) (local.get $x))))))

  (func $negate (export "negate") (param $x i32) (result i32)
    (i31.get_s (ref.cast (ref i31) (call $negate_internal (ref.i31 (local.get $x))))))

  (func $closure14 (type $ClosureFunc1) (param $__env anyref) (param $s anyref) (result anyref)
    (call $assoc (local.get $s) (struct.new $Keyword (i32.const 6)) (call $array_get (local.get $__env) (i32.const 0))))

  (func $set_left_input_internal (param $dir anyref) (result anyref)
    (local $__tmp_env anyref)
    (block (result anyref)
      (call $swap_BANG_ (global.get $state) (struct.new $Closure1 (ref.func $closure14) (block (result anyref)
        (local.set $__tmp_env (call $array_new (i32.const 1)))
        (call $array_set (local.get $__tmp_env) (i32.const 0) (local.get $dir))
        (local.get $__tmp_env))))
      drop
      (local.get $dir)))

  (func $set_left_input (export "set-left-input") (param $dir i32) (result i32)
    (i31.get_s (ref.cast (ref i31) (call $set_left_input_internal (ref.i31 (local.get $dir))))))

  (func $closure15 (type $ClosureFunc1) (param $__env anyref) (param $s anyref) (result anyref)
    (call $assoc (local.get $s) (struct.new $Keyword (i32.const 1)) (call $array_get (local.get $__env) (i32.const 0))))

  (func $set_right_input_internal (param $dir anyref) (result anyref)
    (local $__tmp_env anyref)
    (block (result anyref)
      (call $swap_BANG_ (global.get $state) (struct.new $Closure1 (ref.func $closure15) (block (result anyref)
        (local.set $__tmp_env (call $array_new (i32.const 1)))
        (call $array_set (local.get $__tmp_env) (i32.const 0) (local.get $dir))
        (local.get $__tmp_env))))
      drop
  ...
  (func $set_right_input (export "set-right-input") (param $dir i32) (result i32)
    (i31.get_s (ref.cast (ref i31) (call $set_right_input_internal (ref.i31 (local.get $dir))))))

  (func $get_ball_x_internal  (result anyref)
    (call $hash_map_get (call $deref (global.get $state)) (struct.new $Keyword (i32.const 3))))

  (func $get_ball_x (export "get-ball-x")  (result i32)
    (i31.get_s (ref.cast (ref i31) (call $get_ball_x_internal ))))

  (func $get_ball_y_internal  (result anyref)
    (call $hash_map_get (call $deref (global.get $state)) (struct.new $Keyword (i32.const 5))))

  (func $get_ball_y (export "get-ball-y")  (result i32)
    (i31.get_s (ref.cast (ref i31) (call $get_ball_y_internal ))))

  (func $get_paddle_left_internal  (result anyref)
    (call $hash_map_get (call $deref (global.get $state)) (struct.new $Keyword (i32.const 2))))

  (func $get_paddle_left (export "get-paddle-left")  (result i32)
    (i31.get_s (ref.cast (ref i31) (call $get_paddle_left_internal ))))

  (func $get_paddle_right_internal  (result anyref)
    (call $hash_map_get (call $deref (global.get $state)) (struct.new $Keyword (i32.const 4))))

  (func $get_paddle_right (export "get-paddle-right")  (result i32)
    (i31.get_s (ref.cast (ref i31) (call $get_paddle_right_internal ))))

  (func $get_score_left_internal  (result anyref)
    (call $hash_map_get (call $deref (global.get $state)) (struct.new $Keyword (i32.const 7))))

  (func $get_score_left (export "get-score-left")  (result i32)
    (i31.get_s (ref.cast (ref i31) (call $get_score_left_internal ))))

  (func $get_score_right_internal  (result anyref)
    (call $hash_map_get (call $deref (global.get $state)) (struct.new $Keyword (i32.const 0))))

  (func $get_score_right (export "get-score-right")  (result i32)
    (i31.get_s (ref.cast (ref i31) (call $get_score_right_internal ))))

  (func $move_paddle_internal (param $s anyref) (param $paddle_key anyref) (param $input_key anyref) (result anyref)
    (local $paddle anyref)
    (local $input anyref)
    (local $new_paddle anyref)
    (block (result anyref)
      (local.set $paddle (call $hash_map_get (local.get $s) (local.get $paddle_key)))
      (local.set $input (call $hash_map_get (local.get $s) (local.get $input_key)))
      (local.set $new_paddle (call $clamp_internal (ref.i31 (i32.add (i31.get_s (ref.cast (ref i31) (local.get $paddle))) (i31.get_s (ref.cast (ref i31) (ref.i31 (i32.mul (i31.get_s (ref.cast (ref i31) (local.get $input))) (i31.get_s (ref.cast (ref i31) (global.get $paddle_speed))))))))) (global.get $half_paddle) (ref.i31 (i32.sub (i31.get_s (ref.cast (ref i31) (global.get $height))) (i31.get_s (ref.cast (ref i31) (global.get $half_paddle)))))))
      (call $assoc (local.get $s) (local.get $paddle_key) (local.get $new_paddle))))

  (func $move_paddle (export "move-paddle") (param $s i32) (param $paddle_key i32) (param $input_key i32) (result i32)
    (i31.get_s (ref.cast (ref i31) (call $move_paddle_internal (ref.i31 (local.get $s)) (ref.i31 (local.get $paddle_key)) (ref.i31 (local.get $input_key))))))

  (func $update_paddles_internal (param $s anyref) (result anyref)
    (call $move_paddle_internal (call $move_paddle_internal (local.get $s) (struct.new $Keyword (i32.const 2)) (struct.new $Keyword (i32.const 6))) (struct.new $Keyword (i32.const 4)) (struct.new $Keyword (i32.const 1))))

  (func $update_paddles (export "update-paddles") (param $s i32) (result i32)
    (i31.get_s (ref.cast (ref i31) (call $update_paddles_internal (ref.i31 (local.get $s))))))

  (func $update_ball_position_internal (param $s anyref) (result anyref)
    (call $assoc (call $assoc (local.get $s) (struct.new $Keyword (i32.const 3)) (ref.i31 (i32.add (i31.get_s (ref.cast (ref i31) (call $hash_map_get (local.get $s) (struct.new $Keyword (i32.const 3))))) (i31.get_s (ref.cast (ref i31) (call $hash_map_get (local.get $s) (struct.new $Keyword (i32.const 9)))))))) (struct.new $Keyword (i32.const 5)) (ref.i31 (i32.add (i31.get_s (ref.cast (ref i31) (call $hash_map_get (local.get $s) (struct.new $Keyword (i32.const 5))))) (i31.get_s (ref.cast (ref i31) (call $hash_map_get (local.get $s) (struct.new $Keyword (i32.const 8)))))))))

  (func $update_ball_position (export "update-ball-position") (param $s i32) (result i32)
    (i31.get_s (ref.cast (ref i31) (call $update_ball_position_internal (ref.i31 (local.get $s))))))

  (func $bounce_top_internal (param $s anyref) (result anyref)
    (if (result anyref)
      (call $truthy (ref.i31 (i32.lt_s (i31.get_s (ref.cast (ref i31) (call $hash_map_get (local.get $s) (struct.new $Keyword (i32.const 5))))) (i31.get_s (ref.cast (ref i31) (global.get $half_ball))))))
      (then (call $assoc (call $assoc (local.get $s) (struct.new $Keyword (i32.const 5)) (global.get $half_ball)) (struct.new $Keyword (i32.const 8)) (call $negate_internal (call $hash_map_get (local.get $s) (struct.new $Keyword (i32.const 8))))))
      (else (local.get $s))))

  (func $bounce_top (export "bounce-top") (param $s i32) (result i32)
    (i31.get_s (ref.cast (ref i31) (call $bounce_top_internal (ref.i31 (local.get $s))))))

  (func $bounce_bottom_internal (param $s anyref) (result anyref)
    (if (result anyref)
      (call $truthy (ref.i31 (i32.gt_s (i31.get_s (ref.cast (ref i31) (call $hash_map_get (local.get $s) (struct.new $Keyword (i32.const 5))))) (i31.get_s (ref.cast (ref i31) (ref.i31 (i32.sub (i31.get_s (ref.cast (ref i31) (global.get $height))) (i31.get_s (ref.cast (ref i31) (global.get $half_ball))))))))))
      (then (call $assoc (call $assoc (local.get $s) (struct.new $Keyword (i32.const 5)) (ref.i31 (i32.sub (i31.get_s (ref.cast (ref i31) (global.get $height))) (i31.get_s (ref.cast (ref i31) (global.get $half_ball)))))) (struct.new $Keyword (i32.const 8)) (call $negate_internal (call $hash_map_get (local.get $s) (struct.new $Keyword (i32.const 8))))))
      (else (local.get $s))))

  (func $bounce_bottom (export "bounce-bottom") (param $s i32) (result i32)
    (i31.get_s (ref.cast (ref i31) (call $bounce_bottom_internal (ref.i31 (local.get $s))))))

  (func $bounce_walls_internal (param $s anyref) (result anyref)
    (call $bounce_bottom_internal (call $bounce_top_internal (local.get $s))))

  (func $bounce_walls (export "bounce-walls") (param $s i32) (result i32)
    (i31.get_s (ref.cast (ref i31) (call $bounce_walls_internal (ref.i31 (local.get $s))))))

  (func $paddle_hit_QMARK__internal (param $ball_y anyref) (param $paddle_y anyref) (result anyref)
    (if (result anyref) (i31.get_s (ref.cast (ref i31) (ref.i31 (i32.ge_s (i31.get_s (ref.cast (ref i31) (local.get $ball_y))) (i31.get_s (ref.cast (ref i31) (ref.i31 (i32.sub (i31.get_s (ref.cast (ref i31) (local.get $paddle_y))) (i31.get_s (ref.cast (ref i31) (global.get $half_paddle)))))))))))
        (then (ref.i31 (i32.le_s (i31.get_s (ref.cast (ref i31) (local.get $ball_y))) (i31.get_s (ref.cast (ref i31) (ref.i31 (i32.add (i31.get_s (ref.cast (ref i31) (local.get $paddle_y))) (i31.get_s (ref.cast (ref i31) (global.get $half_paddle))))))))))
        (else (ref.i31 (i32.const 0)))))

  (func $paddle_hit_QMARK_ (export "paddle-hit?") (param $ball_y i32) (param $paddle_y i32) (result i32)
    (i31.get_s (ref.cast (ref i31) (call $paddle_hit_QMARK__internal (ref.i31 (local.get $ball_y)) (ref.i31 (local.get $paddle_y))))))

  (func $check_left_paddle_internal (param $s anyref) (result anyref)
    (local $ball_x anyref)
    (local $ball_y anyref)
    (local $vel_x anyref)
    (local $paddle anyref)
    (block (result anyref)
      (local.set $ball_x (call $hash_map_get (local.get $s) (struct.new $Keyword (i32.const 3))))
      (local.set $ball_y (call $hash_map_get (local.get $s) (struct.new $Keyword (i32.const 5))))
      (local.set $vel_x (call $hash_map_get (local.get $s) (struct.new $Keyword (i32.const 9))))
      (local.set $paddle (call $hash_map_get (local.get $s) (struct.new $Keyword (i32.const 2))))
      (if (result anyref)
      (call $truthy (if (result anyref) (i31.get_s (ref.cast (ref i31) (ref.i31 (i32.le_s (i31.get_s (ref.cast (ref i31) (ref.i31 (i32.sub (i31.get_s (ref.cast (ref i31) (local.get $ball_x))) (i31.get_s (ref.cast (ref i31) (global.get $half_ball))))))) (i31.get_s (ref.cast (ref i31) (global.get $paddle_width)))))))
        (then (ref.i31 (i32.lt_s (i31.get_s (ref.cast (ref i31) (local.get $vel_x))) (i31.get_s (ref.cast (ref i31) (ref.i31 (i32.const 0)))))))
        (else (ref.i31 (i32.const 0)))))
      (then (call $assoc (call $assoc (local.get $s) (struct.new $Keyword (i32.const 3)) (ref.i31 (i32.add (i31.get_s (ref.cast (ref i31) (global.get $paddle_width))) (i31.get_s (ref.cast (ref i31) (global.get $half_ball)))))) (struct.new $Keyword (i32.const 9)) (call $negate_internal (local.get $vel_x))))
      (else (local.get $s)))))

  (func $check_left_paddle (export "check-left-paddle") (param $s i32) (result i32)
    (i31.get_s (ref.cast (ref i31) (call $check_left_paddle_internal (ref.i31 (local.get $s))))))

  (func $check_right_paddle_internal (param $s anyref) (result anyref)
    (local $ball_x anyref)
    (local $ball_y anyref)
    (local $vel_x anyref)
    (local $paddle anyref)
    (block (result anyref)
      ...
      (local.set $ball_y (call $hash_map_get (local.get $s) (struct.new $Keyword (i32.const 5))))
      (local.set $vel_x (call $hash_map_get (local.get $s) (struct.new $Keyword (i32.const 9))))
      (local.set $paddle (call $hash_map_get (local.get $s) (struct.new $Keyword (i32.const 4))))
      (if (result anyref)
      (call $truthy (if (result anyref) (i31.get_s (ref.cast (ref i31) (ref.i31 (i32.ge_s (i31.get_s (ref.cast (ref i31) (ref.i31 (i32.add (i31.get_s (ref.cast (ref i31) (local.get $ball_x))) (i31.get_s (ref.cast (ref i31) (global.get $half_ball))))))) (i31.get_s (ref.cast (ref i31) (ref.i31 (i32.sub (i31.get_s (ref.cast (ref i31) (global.get $width))) (i31.get_s (ref.cast (ref i31) (global.get $paddle_width)))))))))))
        (then (ref.i31 (i32.gt_s (i31.get_s (ref.cast (ref i31) (local.get $vel_x))) (i31.get_s (ref.cast (ref i31) (ref.i31 (i32.const 0)))))))
        (else (ref.i31 (i32.const 0)))))
      (then (call $assoc (call $assoc (local.get $s) (struct.new $Keyword (i32.const 3)) (ref.i31 (i32.sub (i31.get_s (ref.cast (ref i31) (ref.i31 (i32.sub (i31.get_s (ref.cast (ref i31) (global.get $width))) (i31.get_s (ref.cast (ref i31) (global.get $paddle_width))))))) (i31.get_s (ref.cast (ref i31) (global.get $half_ball)))))) (struct.new $Keyword (i32.const 9)) (call $negate_internal (local.get $vel_x))))
      (else (local.get $s)))))

  (func $check_right_paddle (export "check-right-paddle") (param $s i32) (result i32)
    (i31.get_s (ref.cast (ref i31) (call $check_right_paddle_internal (ref.i31 (local.get $s))))))

  (func $check_paddles_internal (param $s anyref) (result anyref)
    (call $check_right_paddle_internal (call $check_left_paddle_internal (local.get $s))))

  (func $check_paddles (export "check-paddles") (param $s i32) (result i32)
    (i31.get_s (ref.cast (ref i31) (call $check_paddles_internal (ref.i31 (local.get $s))))))

  (func $reset_ball_internal (param $s anyref) (param $direction anyref) (result anyref)
    (call $assoc (call $assoc (call $assoc (call $assoc (local.get $s) (struct.new $Keyword (i32.const 3)) (ref.i31 (i32.const 40000))) (struct.new $Keyword (i32.const 5)) (ref.i31 (i32.const 30000))) (struct.new $Keyword (i32.const 9)) (ref.i31 (i32.mul (i31.get_s (ref.cast (ref i31) (local.get $direction))) (i31.get_s (ref.cast (ref i31) (global.get $ball_speed)))))) (struct.new $Keyword (i32.const 8)) (ref.i31 (i32.const 300))))

  (func $reset_ball (export "reset-ball") (param $s i32) (param $direction i32) (result i32)
    (i31.get_s (ref.cast (ref i31) (call $reset_ball_internal (ref.i31 (local.get $s)) (ref.i31 (local.get $direction))))))

  (func $check_scoring_internal (param $s anyref) (result anyref)
    (local $ball_x anyref)
    (block (result anyref)
      (local.set $ball_x (call $hash_map_get (local.get $s) (struct.new $Keyword (i32.const 3))))
      (if (result anyref)
      (call $truthy (ref.i31 (i32.lt_s (i31.get_s (ref.cast (ref i31) (local.get $ball_x))) (i31.get_s (ref.cast (ref i31) (ref.i31 (i32.const 0)))))))
      (then (call $reset_ball_internal (call $assoc (local.get $s) (struct.new $Keyword (i32.const 0)) (ref.i31 (i32.add (i31.get_s (ref.cast (ref i31) (call $hash_map_get (local.get $s) (struct.new $Keyword (i32.const 0))))) (i32.const 1)))) (ref.i31 (i32.const 1))))
      (else (if (result anyref)
      (call $truthy (ref.i31 (i32.gt_s (i31.get_s (ref.cast (ref i31) (local.get $ball_x))) (i31.get_s (ref.cast (ref i31) (global.get $width))))))
      (then (call $reset_ball_internal (call $assoc (local.get $s) (struct.new $Keyword (i32.const 7)) (ref.i31 (i32.add (i31.get_s (ref.cast (ref i31) (call $hash_map_get (local.get $s) (struct.new $Keyword (i32.const 7))))) (i32.const 1)))) (call $negate_internal (ref.i31 (i32.const 1)))))
      (else (local.get $s)))))))

  (func $check_scoring (export "check-scoring") (param $s i32) (result i32)
    (i31.get_s (ref.cast (ref i31) (call $check_scoring_internal (ref.i31 (local.get $s))))))

  (func $tick_state_internal (param $s anyref) (result anyref)
    (call $check_scoring_internal (call $check_paddles_internal (call $bounce_walls_internal (call $update_ball_position_internal (call $update_paddles_internal (local.get $s)))))))

  (func $tick_state (export "tick-state") (param $s i32) (result i32)
    (i31.get_s (ref.cast (ref i31) (call $tick_state_internal (ref.i31 (local.get $s))))))

  (func $init_internal  (result anyref)
    (block (result anyref)
      (call $reset_BANG_ (global.get $state) (global.get $initial_state))
      drop
      (ref.i31 (i32.const 0))))
  ...
  (func $fn16 (type $ClosureFunc1) (param $__env anyref) (param $s anyref) (result anyref)
    (call $tick_state_internal (local.get $s)))

  (func $tick_internal  (result anyref)
    (block (result anyref)
      (call $swap_BANG_ (global.get $state) (struct.new $Closure1 (ref.func $fn16) (call $array_new (i32.const 0))))
      drop
      (ref.i31 (i32.const 0))))
  ...
  (func $start
    ...
    drop
    (block (result anyref) (global.set $width (ref.i31 (i32.const 80000))) (ref.null none))
    drop
    (block (result anyref) (global.set $height (ref.i31 (i32.const 60000))) (ref.null none))
    drop
    (block (result anyref) (global.set $paddle_height (ref.i31 (i32.const 10000))) (ref.null none))
    drop
    (block (result anyref) (global.set $paddle_width (ref.i31 (i32.const 1000))) (ref.null none))
    drop
    (block (result anyref) (global.set $ball_size (ref.i31 (i32.const 1000))) (ref.null none))
    drop
    (block (result anyref) (global.set $ball_speed (ref.i31 (i32.const 400))) (ref.null none))
    drop
    (block (result anyref) (global.set $paddle_speed (ref.i31 (i32.const 800))) (ref.null none))
    drop
    (block (result anyref) (global.set $half_paddle (ref.i31 (i32.const 5000))) (ref.null none))
    drop
    (block (result anyref) (global.set $half_ball (ref.i31 (i32.const 500))) (ref.null none))
    drop
    (block (result anyref) (global.set $initial_state (call $hash_map_assoc (call $hash_map_assoc (call $hash_map_assoc (call $hash_map_assoc (call $hash_map_assoc (call $hash_map_assoc (call $hash_map_assoc (call $hash_map_assoc (call $hash_map_assoc (call $hash_map_assoc (call $empty_hash_map) (struct.new $Keyword (i32.const 0)) (ref.i31 (i32.const 0))) (struct.new $Keyword (i32.const 1)) (ref.i31 (i32.const 0))) (struct.new $Keyword (i32.const 2)) (ref.i31 (i32.const 25000))) (struct.new $Keyword (i32.const 3)) (ref.i31 (i32.const 40000))) (struct.new $Keyword (i32.const 4)) (ref.i31 (i32.const 25000))) (struct.new $Keyword (i32.const 5)) (ref.i31 (i32.const 30000))) (struct.new $Keyword (i32.const 6)) (ref.i31 (i32.const 0))) (struct.new $Keyword (i32.const 7)) (ref.i31 (i32.const 0))) (struct.new $Keyword (i32.const 8)) (ref.i31 (i32.const 300))) (struct.new $Keyword (i32.const 9)) (ref.i31 (i32.const 400)))) (ref.null none))
    drop
    (block (result anyref) (global.set $state (call $atom (global.get $initial_state))) (ref.null none))
    drop)
  (start $start)
)
