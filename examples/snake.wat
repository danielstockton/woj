(module
  ...
  ;; String: interned string with unique ID
  (type $String (struct (field $id i32)))
  ...
  ;; Works on: Cons, Vector, HashMap (returns first key-value pair as vector), HashSet
  ...
  ;; Works on: Cons, Vector, HashMap, HashSet
  ...
  ;; seq?: check if value is a seq (cons cell)
  ...
  (func $seqable_QMARK_ (param $val anyref) (result anyref)
    (ref.i31 (i32.or (i32.or (i32.or (i32.or
  ...
  ;; cons-reduce: reduce over cons list
  (func $cons_reduce (param $coll anyref) (param $f anyref) (param $init anyref) (result anyref)
    ...
    (block $done
      (loop $loop
        ...
        (local.set $curr (struct.get $Cons $rest (ref.cast (ref $Cons) (local.get $curr))))
        (br $loop)))
  ...
  (global $grid_width (mut anyref) (ref.null none))
  (global $grid_height (mut anyref) (ref.null none))
  (global $dir_up (mut anyref) (ref.null none))
  (global $dir_right (mut anyref) (ref.null none))
  (global $dir_down (mut anyref) (ref.null none))
  (global $dir_left (mut anyref) (ref.null none))
  (global $game_state (mut anyref) (ref.null none))
  (global $rng_state (mut anyref) (ref.null none))
  (global $__builtin__STAR_ (mut anyref) (ref.null none))

  ;; Closure function declarations
  (elem declare func $closure1 $closure2 $closure3 $closure4 $closure5 $closure6 $closure7 $closure8 $closure9 $fn10 $closure11 $closure12 $closure13 $closure14 $fn15 $closure16 $__builtin__STAR__fn)
  ...
  (func $map_internal (param $f anyref) (param $coll anyref) (result anyref)
    (if (result anyref)
      ...
      (then (ref.null none))
      (else (call $cons (call $invoke1 (local.get $f) (call $first (local.get $coll))) (call $map_internal (local.get $f) (call $rest (local.get $coll)))))))
  ...
  (func $filter_internal (param $pred anyref) (param $coll anyref) (result anyref)
    (if (result anyref)
      ...
      (then (call $cons (call $first (local.get $coll)) (call $filter_internal (local.get $pred) (call $rest (local.get $coll)))))
      (else (call $filter_internal (local.get $pred) (call $rest (local.get $coll))))))))
  ...
  (func $take_internal (param $n anyref) (param $coll anyref) (result anyref)
    (if (result anyref)
      (call $truthy (if (result anyref) (i31.get_s (ref.cast (ref i31) (ref.i31 (i32.eqz (i31.get_s (ref.cast (ref i31) (local.get $n)))))))
        (then (ref.i31 (i32.eqz (i31.get_s (ref.cast (ref i31) (local.get $n))))))
        (else (call $nil_QMARK_ (local.get $coll)))))
      (then (ref.null none))
      (else (call $cons (call $first (local.get $coll)) (call $take_internal (ref.i31 (i32.sub (i31.get_s (ref.cast (ref i31) (local.get $n))) (i32.const 1))) (call $rest (local.get $coll)))))))
  ...
  (func $drop_internal (param $n anyref) (param $coll anyref) (result anyref)
    (if (result anyref)
      (call $truthy (if (result anyref) (i31.get_s (ref.cast (ref i31) (ref.i31 (i32.eqz (i31.get_s (ref.cast (ref i31) (local.get $n)))))))
        ...
        (else (call $nil_QMARK_ (local.get $coll)))))
      (then (local.get $coll))
      (else (call $drop_internal (ref.i31 (i32.sub (i31.get_s (ref.cast (ref i31) (local.get $n))) (i32.const 1))) (call $rest (local.get $coll))))))
  ...
  (func $range_from_internal (param $start anyref) (param $end anyref) (result anyref)
    (if (result anyref)
      (call $truthy (ref.i31 (i32.ge_s (i31.get_s (ref.cast (ref i31) (local.get $start))) (i31.get_s (ref.cast (ref i31) (local.get $end))))))
      (then (ref.null none))
      (else (call $cons (local.get $start) (call $range_from_internal (ref.i31 (i32.add (i31.get_s (ref.cast (ref i31) (local.get $start))) (i32.const 1))) (local.get $end))))))

  (func $range_from (export "range-from") (param $start i32) (param $end i32) (result i32)
    (i31.get_s (ref.cast (ref i31) (call $range_from_internal (ref.i31 (local.get $start)) (ref.i31 (local.get $end))))))
  ...
  (func $closure1 (type $ClosureFunc1) (param $__env anyref) (param $y anyref) (result anyref)
    (ref.i31 (i32.eq (i31.get_s (ref.cast (ref i31) (call $array_get (local.get $__env) (i32.const 0)))) (i31.get_s (ref.cast (ref i31) (local.get $y))))))
  ...
  (func $distinct_internal (param $coll anyref) (result anyref)
    ...
    (block (result anyref)
      ...
      (if (result anyref)
      (call $truthy (call $some_internal (struct.new $Closure1 (ref.func $closure1) (block (result anyref)
  ...
  (func $partition_internal (param $n anyref) (param $coll anyref) (result anyref)
    ...
    (if (result anyref)
      ...
      (if (result anyref)
      (call $truthy (ref.i31 (i32.eq (i31.get_s (ref.cast (ref i31) (call $length_internal (local.get $chunk)))) (i31.get_s (ref.cast (ref i31) (local.get $n))))))
  ...
  (func $closure2 (type $ClosureFunc1) (param $__env anyref) (param $x anyref) (result anyref)
  ...
  (func $remove_internal (param $pred anyref) (param $coll anyref) (result anyref)
    (local $__tmp_env anyref)
    (call $filter_internal (struct.new $Closure1 (ref.func $closure2) (block (result anyref)
        (local.set $__tmp_env (call $array_new (i32.const 1)))
  ...
  (func $closure3 (type $ClosureFunc1) (param $__env anyref) (param $elem anyref) (result anyref)
  ...
  (func $subset_QMARK__internal (param $s1 anyref) (param $s2 anyref) (result anyref)
    (local $__tmp_env anyref)
    (call $every_QMARK__internal (struct.new $Closure1 (ref.func $closure3) (block (result anyref)
        (local.set $__tmp_env (call $array_new (i32.const 1)))
  ...
  (func $closure4 (type $ClosureFunc1) (param $__env anyref) (param $_ anyref) (result anyref)
    (call $array_get (local.get $__env) (i32.const 0)))

  (func $constantly_internal (param $x anyref) (result anyref)
    (local $__tmp_env anyref)
    (struct.new $Closure1 (ref.func $closure4) (block (result anyref)
        (local.set $__tmp_env (call $array_new (i32.const 1)))
        (call $array_set (local.get $__tmp_env) (i32.const 0) (local.get $x))
        (local.get $__tmp_env))))
  ...
  (func $closure5 (type $ClosureFunc1) (param $__env anyref) (param $x anyref) (result anyref)
  ...
  (func $comp_internal (param $f anyref) (param $g anyref) (result anyref)
    (local $__tmp_env anyref)
    (struct.new $Closure1 (ref.func $closure5) (block (result anyref)
  ...
  (func $partial_internal (param $f anyref) (param $x anyref) (result anyref)
    (local $__tmp_env anyref)
    (struct.new $Closure1 (ref.func $closure6) (block (result anyref)
        (local.set $__tmp_env (call $array_new (i32.const 2)))
        (call $array_set (local.get $__tmp_env) (i32.const 0) (local.get $f))
  ...
  (func $complement_internal (param $f anyref) (result anyref)
    (local $__tmp_env anyref)
    (struct.new $Closure1 (ref.func $closure7) (block (result anyref)
        (local.set $__tmp_env (call $array_new (i32.const 1)))
        (call $array_set (local.get $__tmp_env) (i32.const 0) (local.get $f))
        (local.get $__tmp_env))))
  ...
  (func $closure8 (type $ClosureFunc1) (param $__env anyref) (param $x anyref) (result anyref)
  ...
  (func $juxt_internal (param $f anyref) (param $g anyref) (result anyref)
    (local $__tmp_env anyref)
    (struct.new $Closure1 (ref.func $closure8) (block (result anyref)
        (local.set $__tmp_env (call $array_new (i32.const 2)))
        (call $array_set (local.get $__tmp_env) (i32.const 0) (local.get $f))
        (call $array_set (local.get $__tmp_env) (i32.const 1) (local.get $g))
        (local.get $__tmp_env))))
  ...
  (func $range_internal (param $start anyref) (param $end anyref) (result anyref)
    (call $range_from_internal (local.get $start) (local.get $end)))

  (func $range (export "range") (param $start i32) (param $end i32) (result i32)
    (i31.get_s (ref.cast (ref i31) (call $range_internal (ref.i31 (local.get $start)) (ref.i31 (local.get $end))))))

  (func $repeat_internal (param $n anyref) (param $x anyref) (result anyref)
    (if (result anyref)
      (call $truthy (ref.i31 (i32.le_s (i31.get_s (ref.cast (ref i31) (local.get $n))) (i31.get_s (ref.cast (ref i31) (ref.i31 (i32.const 0)))))))
      (then (ref.null none))
      (else (call $cons (local.get $x) (call $repeat_internal (ref.i31 (i32.sub (i31.get_s (ref.cast (ref i31) (local.get $n))) (i32.const 1))) (local.get $x))))))

  (func $repeat (export "repeat") (param $n i32) (param $x i32) (result i32)
    (i31.get_s (ref.cast (ref i31) (call $repeat_internal (ref.i31 (local.get $n)) (ref.i31 (local.get $x))))))
  ...
  (func $take_last_internal (param $n anyref) (param $coll anyref) (result anyref)
    (local $len anyref)
    (block (result anyref)
      (local.set $len (ref.i31 (call $vector_count (call $seq (local.get $coll)))))
  ...
  (func $drop_last_internal (param $n anyref) (param $coll anyref) (result anyref)
    (call $take_internal (call $max_internal (ref.i31 (i32.const 0)) (ref.i31 (i32.sub (i31.get_s (ref.cast (ref i31) (ref.i31 (call $vector_count (call $seq (local.get $coll)))))) (i31.get_s (ref.cast (ref i31) (local.get $n)))))) (local.get $coll)))
  ...
  (func $subvec_internal (param $v anyref) (param $start anyref) (param $end anyref) (result anyref)
    ...
    (block (result anyref)
      ...
      (then (local.get $result))
      (else (call $vector_conj (local.get $result) (call $vector_nth (local.get $v) (i31.get_s (ref.cast (ref i31) (local.get $i)))))
  ...
  (func $str_internal (param $x anyref) (result anyref)
    (ref.null none))

  (func $str (export "str") (param $x i32) (result i32)
    (i31.get_s (ref.cast (ref i31) (call $str_internal (ref.i31 (local.get $x))))))
  ...
  (func $name_internal (param $x anyref) (result anyref)
    (ref.null none))

  (func $name (export "name") (param $x i32) (result i32)
    (i31.get_s (ref.cast (ref i31) (call $name_internal (ref.i31 (local.get $x))))))
  ...
  (func $subs_internal (param $s anyref) (param $start anyref) (param $end anyref) (result anyref)
    (ref.null none))

  (func $subs (export "subs") (param $s i32) (param $start i32) (param $end i32) (result i32)
    (i31.get_s (ref.cast (ref i31) (call $subs_internal (ref.i31 (local.get $s)) (ref.i31 (local.get $start)) (ref.i31 (local.get $end))))))
  ...
  (func $closure9 (type $ClosureFunc2) (param $__env anyref) (param $m anyref) (param $x anyref) (result anyref)
    (local $k anyref)
    (block (result anyref)
  ...
  (func $group_by_internal (param $f anyref) (param $coll anyref) (result anyref)
    (local $__tmp_env anyref)
    (call $reduce (struct.new $Closure2 (ref.func $closure9) (block (result anyref)
        (local.set $__tmp_env (call $array_new (i32.const 1)))
        (call $array_set (local.get $__tmp_env) (i32.const 0) (local.get $f))
  ...
  (func $fn10 (type $ClosureFunc2) (param $__env anyref) (param $m anyref) (param $x anyref) (result anyref)
  ...
  (func $frequencies_internal (param $coll anyref) (result anyref)
    (call $reduce (struct.new $Closure2 (ref.func $fn10) (call $array_new (i32.const 0))) (call $empty_hash_map) (local.get $coll)))
  ...
  (func $closure11 (type $ClosureFunc1) (param $__env anyref) (param $x anyref) (result anyref)
  ...
  (func $bit_shift_left_internal (param $a anyref) (param $b anyref) (result anyref)
    (ref.i31 (i32.mul (i31.get_s (ref.cast (ref i31) (local.get $a))) (i31.get_s (ref.cast (ref i31) (call $reduce (global.get $__builtin__STAR_) (ref.i31 (i32.const 1)) (call $repeat_internal (local.get $b) (ref.i31 (i32.const 2)))))))))
  ...
  (func $bit_shift_right_internal (param $a anyref) (param $b anyref) (result anyref)
    (ref.i31 (i32.div_s (i31.get_s (ref.cast (ref i31) (local.get $a))) (i31.get_s (ref.cast (ref i31) (call $reduce (global.get $__builtin__STAR_) (ref.i31 (i32.const 1)) (call $repeat_internal (local.get $b) (ref.i31 (i32.const 2)))))))))
  ...
  (func $peek_internal (param $coll anyref) (result anyref)
    (if (result anyref)
      ...
      (call $truthy (ref.i31 (i32.gt_s (i31.get_s (ref.cast (ref i31) (ref.i31 (call $vector_count (local.get $coll))))) (i31.get_s (ref.cast (ref i31) (ref.i31 (i32.const 0)))))))
      (then (call $vector_nth (local.get $coll) (i31.get_s (ref.cast (ref i31) (ref.i31 (i32.sub (i31.get_s (ref.cast (ref i31) (ref.i31 (call $vector_count (local.get $coll))))) (i32.const 1)))))))
      (else (ref.null none))))
      (else (if (result anyref)
  ...
  (func $pop_internal (param $coll anyref) (result anyref)
    (if (result anyref)
      ...
      (then (if (result anyref)
      (call $truthy (ref.i31 (i32.gt_s (i31.get_s (ref.cast (ref i31) (ref.i31 (call $vector_count (local.get $coll))))) (i31.get_s (ref.cast (ref i31) (ref.i31 (i32.const 0)))))))
      (then (call $subvec_internal (local.get $coll) (ref.i31 (i32.const 0)) (ref.i31 (i32.sub (i31.get_s (ref.cast (ref i31) (ref.i31 (call $vector_count (local.get $coll))))) (i32.const 1)))))
  ...
  (func $repeatedly_internal (param $n anyref) (param $f anyref) (result anyref)
    (if (result anyref)
      (call $truthy (ref.i31 (i32.le_s (i31.get_s (ref.cast (ref i31) (local.get $n))) (i31.get_s (ref.cast (ref i31) (ref.i31 (i32.const 0)))))))
      (then (ref.null none))
      (else (call $cons (call $invoke0 (local.get $f) ) (call $repeatedly_internal (ref.i31 (i32.sub (i31.get_s (ref.cast (ref i31) (local.get $n))) (i32.const 1))) (local.get $f))))))
  ...
  (func $identical_QMARK__internal (param $a anyref) (param $b anyref) (result anyref)
    (ref.i31 (i32.eq (i31.get_s (ref.cast (ref i31) (local.get $a))) (i31.get_s (ref.cast (ref i31) (local.get $b))))))
  ...
  (func $format_internal (param $fmt anyref) (param $_AMP_ anyref) (param $args anyref) (result anyref)
    (ref.null none))

  (func $format (export "format") (param $fmt i32) (param $_AMP_ i32) (param $args i32) (result i32)
    (i31.get_s (ref.cast (ref i31) (call $format_internal (ref.i31 (local.get $fmt)) (ref.i31 (local.get $_AMP_)) (ref.i31 (local.get $args))))))
  ...
  (func $alength_internal (param $arr anyref) (result anyref)
    (ref.i31 (call $vector_count (local.get $arr))))
  ...
  (func $dosync_internal (param $_AMP_ anyref) (param $body anyref) (result anyref)
    (ref.null none))

  (func $dosync (export "dosync") (param $_AMP_ i32) (param $body i32) (result i32)
    (i31.get_s (ref.cast (ref i31) (call $dosync_internal (ref.i31 (local.get $_AMP_)) (ref.i31 (local.get $body))))))
  ...
  (func $next_random_internal  (result anyref)
    ...
    (local $m anyref)
    (local $raw anyref)
    (local $next_val anyref)
    (local $v anyref)
    (block (result anyref)
      (local.set $current (call $deref (global.get $rng_state)))
      (local.set $a (ref.i31 (i32.const 1103)))
      (local.set $c (ref.i31 (i32.const 12345)))
      (local.set $m (ref.i31 (i32.const 65536)))
      (local.set $raw (ref.i31 (i32.add (i31.get_s (ref.cast (ref i31) (ref.i31 (i32.mul (i31.get_s (ref.cast (ref i31) (local.get $current))) (i31.get_s (ref.cast (ref i31) (local.get $a))))))) (i31.get_s (ref.cast (ref i31) (local.get $c))))))
      (local.set $next_val (block (result anyref)
      (local.set $v (local.get $raw))
      (loop $loop15 (result anyref)
        (if (result anyref)
      (call $truthy (ref.i31 (i32.ge_s (i31.get_s (ref.cast (ref i31) (local.get $v))) (i31.get_s (ref.cast (ref i31) (local.get $m))))))
      (then (ref.i31 (i32.sub (i31.get_s (ref.cast (ref i31) (local.get $v))) (i31.get_s (ref.cast (ref i31) (local.get $m)))))
        (local.set $v)
        (br $loop15))
      (else (if (result anyref)
      (call $truthy (ref.i31 (i32.lt_s (i31.get_s (ref.cast (ref i31) (local.get $v))) (i31.get_s (ref.cast (ref i31) (ref.i31 (i32.const 0)))))))
      (then (ref.i31 (i32.add (i31.get_s (ref.cast (ref i31) (local.get $v))) (i31.get_s (ref.cast (ref i31) (local.get $m)))))
        (local.set $v)
        (br $loop15))
      (else (local.get $v))))))))
      (block (result anyref)
      (call $reset_BANG_ (global.get $rng_state) (if (result anyref)
      (call $truthy (ref.i31 (i32.eq (i31.get_s (ref.cast (ref i31) (local.get $next_val))) (i31.get_s (ref.cast (ref i31) (ref.i31 (i32.const 0)))))))
      (then (ref.i31 (i32.const 1)))
      (else (local.get $next_val))))
      drop
      (local.get $next_val))))
  ...
  (func $random_in_range_internal (param $max_val anyref) (result anyref)
    (local $r anyref)
    (local $v anyref)
    (block (result anyref)
      (local.set $r (call $next_random_internal ))
      (block (result anyref)
      (local.set $v (local.get $r))
      (loop $loop16 (result anyref)
        (if (result anyref)
      (call $truthy (ref.i31 (i32.lt_s (i31.get_s (ref.cast (ref i31) (local.get $v))) (i31.get_s (ref.cast (ref i31) (local.get $max_val))))))
      (then (local.get $v))
      (else (ref.i31 (i32.sub (i31.get_s (ref.cast (ref i31) (local.get $v))) (i31.get_s (ref.cast (ref i31) (local.get $max_val)))))
        (local.set $v)
        (br $loop16)))))))

  (func $random_in_range (export "random-in-range") (param $max_val i32) (result i32)
    (i31.get_s (ref.cast (ref i31) (call $random_in_range_internal (ref.i31 (local.get $max_val))))))

  (func $make_pos_internal (param $x anyref) (param $y anyref) (result anyref)
    (call $vector_conj (call $vector_conj (call $empty_vector) (local.get $x)) (local.get $y)))

  (func $make_pos (export "make-pos") (param $x i32) (param $y i32) (result i32)
    (i31.get_s (ref.cast (ref i31) (call $make_pos_internal (ref.i31 (local.get $x)) (ref.i31 (local.get $y))))))

  (func $pos_x_internal (param $pos anyref) (result anyref)
    (call $vector_nth (local.get $pos) (i31.get_s (ref.cast (ref i31) (ref.i31 (i32.const 0))))))

  (func $pos_x (export "pos-x") (param $pos i32) (result i32)
    (i31.get_s (ref.cast (ref i31) (call $pos_x_internal (ref.i31 (local.get $pos))))))

  (func $pos_y_internal (param $pos anyref) (result anyref)
    (call $vector_nth (local.get $pos) (i31.get_s (ref.cast (ref i31) (ref.i31 (i32.const 1))))))

  (func $pos_y (export "pos-y") (param $pos i32) (result i32)
    (i31.get_s (ref.cast (ref i31) (call $pos_y_internal (ref.i31 (local.get $pos))))))

  (func $pos_eq_QMARK__internal (param $p1 anyref) (param $p2 anyref) (result anyref)
    (if (result anyref) (i31.get_s (ref.cast (ref i31) (ref.i31 (i32.eq (i31.get_s (ref.cast (ref i31) (call $pos_x_internal (local.get $p1)))) (i31.get_s (ref.cast (ref i31) (call $pos_x_internal (local.get $p2))))))))
        (then (ref.i31 (i32.eq (i31.get_s (ref.cast (ref i31) (call $pos_y_internal (local.get $p1)))) (i31.get_s (ref.cast (ref i31) (call $pos_y_internal (local.get $p2)))))))
        (else (ref.i31 (i32.const 0)))))

  (func $pos_eq_QMARK_ (export "pos-eq?") (param $p1 i32) (param $p2 i32) (result i32)
    (i31.get_s (ref.cast (ref i31) (call $pos_eq_QMARK__internal (ref.i31 (local.get $p1)) (ref.i31 (local.get $p2))))))

  (func $pos_in_list_QMARK__internal (param $pos anyref) (param $positions anyref) (result anyref)
    (local $remaining anyref)
    (block (result anyref)
      (local.set $remaining (call $seq (local.get $positions)))
      (loop $loop17 (result anyref)
        (if (result anyref)
      (call $truthy (call $nil_QMARK_ (local.get $remaining)))
      (then (ref.i31 (i32.const 0)))
      (else (if (result anyref)
      (call $truthy (call $pos_eq_QMARK__internal (local.get $pos) (call $first (local.get $remaining))))
      (then (ref.i31 (i32.const 1)))
      (else (call $rest (local.get $remaining))
        (local.set $remaining)
        (br $loop17))))))))

  (func $pos_in_list_QMARK_ (export "pos-in-list?") (param $pos i32) (param $positions i32) (result i32)
    (i31.get_s (ref.cast (ref i31) (call $pos_in_list_QMARK__internal (ref.i31 (local.get $pos)) (ref.i31 (local.get $positions))))))

  (func $dir_dx_internal (param $dir anyref) (result anyref)
    (if (result anyref)
      (call $truthy (ref.i31 (i32.eq (i31.get_s (ref.cast (ref i31) (local.get $dir))) (i31.get_s (ref.cast (ref i31) (global.get $dir_right))))))
      (then (ref.i31 (i32.const 1)))
      (else (if (result anyref)
      (call $truthy (ref.i31 (i32.eq (i31.get_s (ref.cast (ref i31) (local.get $dir))) (i31.get_s (ref.cast (ref i31) (global.get $dir_left))))))
      (then (ref.i31 (i32.const -1)))
      (else (ref.i31 (i32.const 0)))))))

  (func $dir_dx (export "dir-dx") (param $dir i32) (result i32)
    (i31.get_s (ref.cast (ref i31) (call $dir_dx_internal (ref.i31 (local.get $dir))))))

  (func $dir_dy_internal (param $dir anyref) (result anyref)
    (if (result anyref)
      (call $truthy (ref.i31 (i32.eq (i31.get_s (ref.cast (ref i31) (local.get $dir))) (i31.get_s (ref.cast (ref i31) (global.get $dir_down))))))
      (then (ref.i31 (i32.const 1)))
      (else (if (result anyref)
      (call $truthy (ref.i31 (i32.eq (i31.get_s (ref.cast (ref i31) (local.get $dir))) (i31.get_s (ref.cast (ref i31) (global.get $dir_up))))))
      (then (ref.i31 (i32.const -1)))
      (else (ref.i31 (i32.const 0)))))))

  (func $dir_dy (export "dir-dy") (param $dir i32) (result i32)
    (i31.get_s (ref.cast (ref i31) (call $dir_dy_internal (ref.i31 (local.get $dir))))))

  (func $opposite_dir_QMARK__internal (param $d1 anyref) (param $d2 anyref) (result anyref)
    (if (result anyref) (i31.get_s (ref.cast (ref i31) (if (result anyref) (i31.get_s (ref.cast (ref i31) (ref.i31 (i32.eq (i31.get_s (ref.cast (ref i31) (local.get $d1))) (i31.get_s (ref.cast (ref i31) (global.get $dir_up)))))))
        (then (ref.i31 (i32.eq (i31.get_s (ref.cast (ref i31) (local.get $d2))) (i31.get_s (ref.cast (ref i31) (global.get $dir_down))))))
        (else (ref.i31 (i32.const 0))))))
        (then (if (result anyref) (i31.get_s (ref.cast (ref i31) (ref.i31 (i32.eq (i31.get_s (ref.cast (ref i31) (local.get $d1))) (i31.get_s (ref.cast (ref i31) (global.get $dir_up)))))))
        (then (ref.i31 (i32.eq (i31.get_s (ref.cast (ref i31) (local.get $d2))) (i31.get_s (ref.cast (ref i31) (global.get $dir_down))))))
        (else (ref.i31 (i32.const 0)))))
        (else (if (result anyref) (i31.get_s (ref.cast (ref i31) (ref.i31 (i32.eq (i31.get_s (ref.cast (ref i31) (local.get $d1))) (i31.get_s (ref.cast (ref i31) (global.get $dir_down)))))))
        (then (ref.i31 (i32.eq (i31.get_s (ref.cast (ref i31) (local.get $d2))) (i31.get_s (ref.cast (ref i31) (global.get $dir_up))))))
        (else (ref.i31 (i32.const 0)))))))

  (func $opposite_dir_QMARK_ (export "opposite-dir?") (param $d1 i32) (param $d2 i32) (result i32)
    (i31.get_s (ref.cast (ref i31) (call $opposite_dir_QMARK__internal (ref.i31 (local.get $d1)) (ref.i31 (local.get $d2))))))

  (func $spawn_food_internal (param $snake anyref) (result anyref)
    (local $attempts anyref)
    (local $x anyref)
    (local $y anyref)
    (local $pos anyref)
    (block (result anyref)
      (local.set $attempts (ref.i31 (i32.const 0)))
      (loop $loop18 (result anyref)
        (if (result anyref)
      (call $truthy (ref.i31 (i32.gt_s (i31.get_s (ref.cast (ref i31) (local.get $attempts))) (i31.get_s (ref.cast (ref i31) (ref.i31 (i32.const 100)))))))
      (then (call $make_pos_internal (ref.i31 (i32.const 0)) (ref.i31 (i32.const 0))))
      (else (block (result anyref)
      (local.set $x (call $random_in_range_internal (global.get $grid_width)))
      (local.set $y (call $random_in_range_internal (global.get $grid_height)))
      (local.set $pos (call $make_pos_internal (local.get $x) (local.get $y)))
      (if (result anyref)
      (call $truthy (call $pos_in_list_QMARK__internal (local.get $pos) (local.get $snake)))
      (then (ref.i31 (i32.add (i31.get_s (ref.cast (ref i31) (local.get $attempts))) (i32.const 1)))
        (local.set $attempts)
        (br $loop18))
      (else (local.get $pos)))))))))

  (func $spawn_food (export "spawn-food") (param $snake i32) (result i32)
    (i31.get_s (ref.cast (ref i31) (call $spawn_food_internal (ref.i31 (local.get $snake))))))

  (func $init_game_internal  (result anyref)
    (local $initial_snake anyref)
    (local $initial_food anyref)
    (block (result anyref)
      (block (result anyref)
      (local.set $initial_snake (call $vector_conj (call $vector_conj (call $vector_conj (call $empty_vector) (call $make_pos_internal (ref.i31 (i32.const 10)) (ref.i31 (i32.const 7)))) (call $make_pos_internal (ref.i31 (i32.const 9)) (ref.i31 (i32.const 7)))) (call $make_pos_internal (ref.i31 (i32.const 8)) (ref.i31 (i32.const 7)))))
      (local.set $initial_food (call $spawn_food_internal (local.get $initial_snake)))
      (call $reset_BANG_ (global.get $game_state) (call $hash_map_assoc (call $hash_map_assoc (call $hash_map_assoc (call $hash_map_assoc (call $hash_map_assoc (call $empty_hash_map) (struct.new $Keyword (i32.const 0)) (local.get $initial_snake)) (struct.new $Keyword (i32.const 1)) (global.get $dir_right)) (struct.new $Keyword (i32.const 2)) (local.get $initial_food)) (struct.new $Keyword (i32.const 3)) (ref.i31 (i32.const 0))) (struct.new $Keyword (i32.const 4)) (ref.i31 (i32.const 0)))))
      drop
      (ref.i31 (i32.const 0))))

  (func $init_game (export "init-game")  (result i32)
    (i31.get_s (ref.cast (ref i31) (call $init_game_internal ))))

  (func $get_snake_length_internal  (result anyref)
    (ref.i31 (call $vector_count (call $hash_map_get (call $deref (global.get $game_state)) (struct.new $Keyword (i32.const 0))))))

  (func $get_snake_length (export "get-snake-length")  (result i32)
    (i31.get_s (ref.cast (ref i31) (call $get_snake_length_internal ))))

  (func $get_snake_x_internal (param $index anyref) (result anyref)
    (local $snake anyref)
    (block (result anyref)
      (local.set $snake (call $hash_map_get (call $deref (global.get $game_state)) (struct.new $Keyword (i32.const 0))))
      (if (result anyref)
      (call $truthy (ref.i31 (i32.lt_s (i31.get_s (ref.cast (ref i31) (local.get $index))) (i31.get_s (ref.cast (ref i31) (ref.i31 (call $vector_count (local.get $snake))))))))
      (then (call $pos_x_internal (call $vector_nth (local.get $snake) (i31.get_s (ref.cast (ref i31) (local.get $index))))))
      (else (ref.i31 (i32.const -1))))))

  (func $get_snake_x (export "get-snake-x") (param $index i32) (result i32)
    (i31.get_s (ref.cast (ref i31) (call $get_snake_x_internal (ref.i31 (local.get $index))))))

  (func $get_snake_y_internal (param $index anyref) (result anyref)
    (local $snake anyref)
    (block (result anyref)
      (local.set $snake (call $hash_map_get (call $deref (global.get $game_state)) (struct.new $Keyword (i32.const 0))))
      (if (result anyref)
      (call $truthy (ref.i31 (i32.lt_s (i31.get_s (ref.cast (ref i31) (local.get $index))) (i31.get_s (ref.cast (ref i31) (ref.i31 (call $vector_count (local.get $snake))))))))
      (then (call $pos_y_internal (call $vector_nth (local.get $snake) (i31.get_s (ref.cast (ref i31) (local.get $index))))))
      (else (ref.i31 (i32.const -1))))))

  (func $get_snake_y (export "get-snake-y") (param $index i32) (result i32)
    (i31.get_s (ref.cast (ref i31) (call $get_snake_y_internal (ref.i31 (local.get $index))))))

  (func $get_food_x_internal  (result anyref)
    (call $pos_x_internal (call $hash_map_get (call $deref (global.get $game_state)) (struct.new $Keyword (i32.const 2)))))

  (func $get_food_x (export "get-food-x")  (result i32)
    (i31.get_s (ref.cast (ref i31) (call $get_food_x_internal ))))

  (func $get_food_y_internal  (result anyref)
    (call $pos_y_internal (call $hash_map_get (call $deref (global.get $game_state)) (struct.new $Keyword (i32.const 2)))))

  (func $get_food_y (export "get-food-y")  (result i32)
    (i31.get_s (ref.cast (ref i31) (call $get_food_y_internal ))))

  (func $get_score_internal  (result anyref)
    (call $hash_map_get (call $deref (global.get $game_state)) (struct.new $Keyword (i32.const 3))))

  (func $get_score (export "get-score")  (result i32)
    (i31.get_s (ref.cast (ref i31) (call $get_score_internal ))))

  (func $is_game_over_internal  (result anyref)
    (if (result anyref)
      (call $truthy (call $hash_map_get (call $deref (global.get $game_state)) (struct.new $Keyword (i32.const 4))))
      (then (ref.i31 (i32.const 1)))
      (else (ref.i31 (i32.const 0)))))

  (func $is_game_over (export "is-game-over")  (result i32)
    (i31.get_s (ref.cast (ref i31) (call $is_game_over_internal ))))

  (func $closure14 (type $ClosureFunc1) (param $__env anyref) (param $s anyref) (result anyref)
    (call $assoc (local.get $s) (struct.new $Keyword (i32.const 1)) (call $array_get (local.get $__env) (i32.const 0))))

  (func $set_direction_internal (param $new_dir anyref) (result anyref)
    (local $current_dir anyref)
    (local $__tmp_env anyref)
    (block (result anyref)
      (block (result anyref)
      (local.set $current_dir (call $hash_map_get (call $deref (global.get $game_state)) (struct.new $Keyword (i32.const 1))))
      (if (result anyref)
      (call $truthy (call $opposite_dir_QMARK__internal (local.get $current_dir) (local.get $new_dir)))
      (then (ref.null none))
      (else (block (result anyref)
      (call $swap_BANG_ (global.get $game_state) (struct.new $Closure1 (ref.func $closure14) (block (result anyref)
        (local.set $__tmp_env (call $array_new (i32.const 1)))
        (call $array_set (local.get $__tmp_env) (i32.const 0) (local.get $new_dir))
        (local.get $__tmp_env))))))))
      drop
      (ref.i31 (i32.const 0))))

  (func $set_direction (export "set-direction") (param $new_dir i32) (result i32)
    (i31.get_s (ref.cast (ref i31) (call $set_direction_internal (ref.i31 (local.get $new_dir))))))

  (func $drop_last_vec_internal (param $v anyref) (result anyref)
    (local $len anyref)
    (local $i anyref)
    (local $result anyref)
    (block (result anyref)
      (local.set $len (ref.i31 (call $vector_count (local.get $v))))
      (if (result anyref)
      (call $truthy (ref.i31 (i32.le_s (i31.get_s (ref.cast (ref i31) (local.get $len))) (i31.get_s (ref.cast (ref i31) (ref.i31 (i32.const 1)))))))
      (then (call $empty_vector))
      (else (block (result anyref)
      ...
      (loop $loop19 (result anyref)
        (if (result anyref)
      (call $truthy (ref.i31 (i32.ge_s (i31.get_s (ref.cast (ref i31) (local.get $i))) (i31.get_s (ref.cast (ref i31) (ref.i31 (i32.sub (i31.get_s (ref.cast (ref i31) (local.get $len))) (i32.const 1))))))))
      (then (local.get $result))
      (else (ref.i31 (i32.add (i31.get_s (ref.cast (ref i31) (local.get $i))) (i32.const 1)))
        (call $vector_conj (local.get $result) (call $vector_nth (local.get $v) (i31.get_s (ref.cast (ref i31) (local.get $i)))))
        (local.set $result)
        (local.set $i)
        (br $loop19)))))))))

  (func $drop_last_vec (export "drop-last-vec") (param $v i32) (result i32)
    (i31.get_s (ref.cast (ref i31) (call $drop_last_vec_internal (ref.i31 (local.get $v))))))

  (func $prepend_vec_internal (param $elem anyref) (param $v anyref) (result anyref)
    (local $i anyref)
    (local $result anyref)
    (block (result anyref)
      (local.set $i (ref.i31 (i32.const 0)))
      (local.set $result (call $vector_conj (call $empty_vector) (local.get $elem)))
      (loop $loop20 (result anyref)
        (if (result anyref)
      (call $truthy (ref.i31 (i32.ge_s (i31.get_s (ref.cast (ref i31) (local.get $i))) (i31.get_s (ref.cast (ref i31) (ref.i31 (call $vector_count (local.get $v))))))))
      (then (local.get $result))
      (else (ref.i31 (i32.add (i31.get_s (ref.cast (ref i31) (local.get $i))) (i32.const 1)))
        (call $vector_conj (local.get $result) (call $vector_nth (local.get $v) (i31.get_s (ref.cast (ref i31) (local.get $i)))))
        (local.set $result)
  ...
  (func $prepend_vec (export "prepend-vec") (param $elem i32) (param $v i32) (result i32)
    (i31.get_s (ref.cast (ref i31) (call $prepend_vec_internal (ref.i31 (local.get $elem)) (ref.i31 (local.get $v))))))

  (func $fn15 (type $ClosureFunc1) (param $__env anyref) (param $s anyref) (result anyref)
    (call $assoc (local.get $s) (struct.new $Keyword (i32.const 4)) (ref.i31 (i32.const 1))))

  (func $closure16 (type $ClosureFunc1) (param $__env anyref) (param $s anyref) (result anyref)
    (call $assoc (local.get $s) (struct.new $Keyword (i32.const 0)) (call $array_get (local.get $__env) (i32.const 0))))
  ...
  (func $tick_internal  (result anyref)
    ...
    (local $new_x anyref)
    (local $new_y anyref)
    (local $new_head anyref)
    (local $hit_wall anyref)
    (local $hit_self anyref)
    (local $ate_food anyref)
    (local $new_snake anyref)
    (local $new_food anyref)
    (local $__tmp_env anyref)
    (if (result anyref)
      (call $truthy (call $hash_map_get (call $deref (global.get $game_state)) (struct.new $Keyword (i32.const 4))))
      (then (ref.i31 (i32.const 0)))
      (else (block (result anyref)
      (local.set $state (call $deref (global.get $game_state)))
      (local.set $snake (call $hash_map_get (local.get $state) (struct.new $Keyword (i32.const 0))))
      (local.set $dir (call $hash_map_get (local.get $state) (struct.new $Keyword (i32.const 1))))
      (local.set $food (call $hash_map_get (local.get $state) (struct.new $Keyword (i32.const 2))))
      (local.set $score (call $hash_map_get (local.get $state) (struct.new $Keyword (i32.const 3))))
      (local.set $head (call $first (local.get $snake)))
      (local.set $new_x (ref.i31 (i32.add (i31.get_s (ref.cast (ref i31) (call $pos_x_internal (local.get $head)))) (i31.get_s (ref.cast (ref i31) (call $dir_dx_internal (local.get $dir)))))))
      (local.set $new_y (ref.i31 (i32.add (i31.get_s (ref.cast (ref i31) (call $pos_y_internal (local.get $head)))) (i31.get_s (ref.cast (ref i31) (call $dir_dy_internal (local.get $dir)))))))
      (local.set $new_head (call $make_pos_internal (local.get $new_x) (local.get $new_y)))
      (local.set $hit_wall (if (result anyref) (i31.get_s (ref.cast (ref i31) (ref.i31 (i32.lt_s (i31.get_s (ref.cast (ref i31) (local.get $new_x))) (i31.get_s (ref.cast (ref i31) (ref.i31 (i32.const 0))))))))
        (then (ref.i31 (i32.lt_s (i31.get_s (ref.cast (ref i31) (local.get $new_x))) (i31.get_s (ref.cast (ref i31) (ref.i31 (i32.const 0)))))))
        (else (ref.i31 (i32.ge_s (i31.get_s (ref.cast (ref i31) (local.get $new_x))) (i31.get_s (ref.cast (ref i31) (global.get $grid_width))))))))
      (local.set $hit_self (call $pos_in_list_QMARK__internal (local.get $new_head) (local.get $snake)))
      (local.set $ate_food (call $pos_eq_QMARK__internal (local.get $new_head) (local.get $food)))
      (if (result anyref)
      (call $truthy (if (result anyref) (i31.get_s (ref.cast (ref i31) (local.get $hit_wall)))
        (then (local.get $hit_wall))
        (else (local.get $hit_self))))
      (then (block (result anyref)
      (call $swap_BANG_ (global.get $game_state) (struct.new $Closure1 (ref.func $fn15) (call $array_new (i32.const 0))))
      drop
      (ref.i31 (i32.const 0))))
      (else (if (result anyref)
      (call $truthy (local.get $ate_food))
      (then (block (result anyref)
      (local.set $new_snake (call $prepend_vec_internal (local.get $new_head) (local.get $snake)))
      (local.set $new_food (call $spawn_food_internal (local.get $new_snake)))
      (block (result anyref)
      (call $reset_BANG_ (global.get $game_state) (call $hash_map_assoc (call $hash_map_assoc (call $hash_map_assoc (call $hash_map_assoc (call $hash_map_assoc (call $empty_hash_map) (struct.new $Keyword (i32.const 0)) (local.get $new_snake)) (struct.new $Keyword (i32.const 1)) (local.get $dir)) (struct.new $Keyword (i32.const 2)) (local.get $new_food)) (struct.new $Keyword (i32.const 3)) (ref.i31 (i32.add (i31.get_s (ref.cast (ref i31) (local.get $score))) (i32.const 1)))) (struct.new $Keyword (i32.const 4)) (ref.i31 (i32.const 0))))
      drop
      (ref.i31 (i32.const 0)))))
      (else (block (result anyref)
      (local.set $new_snake (call $prepend_vec_internal (local.get $new_head) (call $drop_last_vec_internal (local.get $snake))))
      (block (result anyref)
      (call $swap_BANG_ (global.get $game_state) (struct.new $Closure1 (ref.func $closure16) (block (result anyref)
        (local.set $__tmp_env (call $array_new (i32.const 1)))
        (call $array_set (local.get $__tmp_env) (i32.const 0) (local.get $new_snake))
        (local.get $__tmp_env))))
      drop
      (ref.i31 (i32.const 0))))))))))))
  ...
  (func $seed_random_internal (param $seed anyref) (result anyref)
    (block (result anyref)
      (call $reset_BANG_ (global.get $rng_state) (if (result anyref)
      (call $truthy (ref.i31 (i32.eq (i31.get_s (ref.cast (ref i31) (local.get $seed))) (i31.get_s (ref.cast (ref i31) (ref.i31 (i32.const 0)))))))
      (then (ref.i31 (i32.const 1)))
      (else (local.get $seed))))
      drop
      (ref.i31 (i32.const 0))))

  (func $seed_random (export "seed-random") (param $seed i32) (result i32)
    (i31.get_s (ref.cast (ref i31) (call $seed_random_internal (ref.i31 (local.get $seed))))))

  (func $test_snake_internal  (result anyref)
    (local $len anyref)
    (local $x anyref)
    (local $y anyref)
    (block (result anyref)
      (call $seed_random_internal (ref.i31 (i32.const 42)))
      drop
      (call $init_game_internal )
      drop
      (call $tick_internal )
      drop
      (block (result anyref)
      (local.set $len (call $get_snake_length_internal ))
      (local.set $x (call $get_snake_x_internal (ref.i31 (i32.const 0))))
      (local.set $y (call $get_snake_y_internal (ref.i31 (i32.const 0))))
      (if (result anyref)
      (call $truthy (if (result anyref) (i31.get_s (ref.cast (ref i31) (ref.i31 (i32.eq (i31.get_s (ref.cast (ref i31) (local.get $len))) (i31.get_s (ref.cast (ref i31) (ref.i31 (i32.const 3))))))))
        (then (ref.i31 (i32.eq (i31.get_s (ref.cast (ref i31) (local.get $x))) (i31.get_s (ref.cast (ref i31) (ref.i31 (i32.const 11)))))))
        (else (ref.i31 (i32.const 0)))))
      (then (ref.i31 (i32.const 0)))
      (else (ref.i31 (i32.const 1)))))))

  (func $test_snake (export "test-snake")  (result i32)
    (i31.get_s (ref.cast (ref i31) (call $test_snake_internal ))))
  ...
  (func $start
    ...
    drop
    (block (result anyref) (global.set $grid_width (ref.i31 (i32.const 20))) (ref.null none))
    drop
    (block (result anyref) (global.set $grid_height (ref.i31 (i32.const 15))) (ref.null none))
    drop
    (block (result anyref) (global.set $dir_up (ref.i31 (i32.const 0))) (ref.null none))
    drop
    (block (result anyref) (global.set $dir_right (ref.i31 (i32.const 1))) (ref.null none))
    drop
    (block (result anyref) (global.set $dir_down (ref.i31 (i32.const 2))) (ref.null none))
    drop
    (block (result anyref) (global.set $dir_left (ref.i31 (i32.const 3))) (ref.null none))
    drop
    (block (result anyref) (global.set $game_state (call $atom (ref.null none))) (ref.null none))
    drop
    (block (result anyref) (global.set $rng_state (call $atom (ref.i31 (i32.const 12345)))) (ref.null none))
    drop)
  (start $start)
)
