(module
  ...
  (global $grid_w (mut anyref) (ref.null none))
  (global $grid_h (mut anyref) (ref.null none))
  (global $total_cells (mut anyref) (ref.null none))
  (global $color_bg (mut anyref) (ref.null none))
  (global $state (mut anyref) (ref.null none))
  (global $rng (mut anyref) (ref.null none))
  (global $glider (mut anyref) (ref.null none))
  (global $rpentomino (mut anyref) (ref.null none))
  (global $lwss (mut anyref) (ref.null none))
  (global $pulsar (mut anyref) (ref.null none))
  (global $glider_gun (mut anyref) (ref.null none))
  (global $__builtin__STAR_ (mut anyref) (ref.null none))

  ;; Closure function declarations
  (elem declare func $closure1 $closure2 $closure3 $closure4 $closure5 $closure6 $closure7 $closure8 $closure9 $closure10 $closure11 $closure12 $closure13 $closure14 $closure15 $closure16 $closure17 $closure18 $closure19 $fn20 $closure21 $closure22 $closure23 $fn24 $fn25 $fn26 $fn27 $fn28 $closure29 $closure30 $fn31 $fn32 $fn33 $fn34 $fn35 $fn36 $__builtin__STAR__fn)
  ...
  (func $next_random_internal  (result anyref)
    (local $s anyref)
    (local $nv anyref)
    (local $v anyref)
    (block (result anyref)
      (local.set $s (call $deref (global.get $rng)))
      (local.set $nv (ref.i31 (i32.add (i31.get_s (ref.cast (ref i31) (ref.i31 (i32.mul (i31.get_s (ref.cast (ref i31) (local.get $s))) (i31.get_s (ref.cast (ref i31) (ref.i31 (i32.const 1103)))))))) (i31.get_s (ref.cast (ref i31) (ref.i31 (i32.const 12345)))))))
      (local.set $nv (block (result anyref)
      (local.set $v (local.get $nv))
      (loop $loop16 (result anyref)
        (if (result anyref)
      (call $truthy (ref.i31 (i32.ge_s (i31.get_s (ref.cast (ref i31) (local.get $v))) (i31.get_s (ref.cast (ref i31) (ref.i31 (i32.const 65536)))))))
      (then (ref.i31 (i32.sub (i31.get_s (ref.cast (ref i31) (local.get $v))) (i31.get_s (ref.cast (ref i31) (ref.i31 (i32.const 65536))))))
        (local.set $v)
        (br $loop16))
      (else (if (result anyref)
      (call $truthy (ref.i31 (i32.lt_s (i31.get_s (ref.cast (ref i31) (local.get $v))) (i31.get_s (ref.cast (ref i31) (ref.i31 (i32.const 0)))))))
      (then (ref.i31 (i32.add (i31.get_s (ref.cast (ref i31) (local.get $v))) (i31.get_s (ref.cast (ref i31) (ref.i31 (i32.const 65536))))))
        (local.set $v)
        (br $loop16))
      (else (local.get $v))))))))
      (block (result anyref)
      (call $reset_BANG_ (global.get $rng) (if (result anyref)
      (call $truthy (ref.i31 (call $eq (local.get $nv) (ref.i31 (i32.const 0)))))
      (then (ref.i31 (i32.const 1)))
      (else (local.get $nv))))
      drop
      (local.get $nv))))

  (func $next_random (export "next-random")  (result i32)
    (i31.get_s (ref.cast (ref i31) (call $next_random_internal ))))

  (func $cell_index_internal (param $x anyref) (param $y anyref) (result anyref)
    (ref.i31 (i32.add (i31.get_s (ref.cast (ref i31) (ref.i31 (i32.mul (i31.get_s (ref.cast (ref i31) (local.get $y))) (i31.get_s (ref.cast (ref i31) (global.get $grid_w))))))) (i31.get_s (ref.cast (ref i31) (local.get $x))))))

  (func $cell_index (export "cell-index") (param $x i32) (param $y i32) (result i32)
    (i31.get_s (ref.cast (ref i31) (call $cell_index_internal (ref.i31 (local.get $x)) (ref.i31 (local.get $y))))))

  (func $cell_x_internal (param $i anyref) (result anyref)
    (ref.i31 (i32.sub (i31.get_s (ref.cast (ref i31) (local.get $i))) (i31.get_s (ref.cast (ref i31) (ref.i31 (i32.mul (i31.get_s (ref.cast (ref i31) (ref.i31 (i32.div_s (i31.get_s (ref.cast (ref i31) (local.get $i))) (i31.get_s (ref.cast (ref i31) (global.get $grid_w))))))) (i31.get_s (ref.cast (ref i31) (global.get $grid_w))))))))))

  (func $cell_x (export "cell-x") (param $i i32) (result i32)
    (i31.get_s (ref.cast (ref i31) (call $cell_x_internal (ref.i31 (local.get $i))))))

  (func $cell_y_internal (param $i anyref) (result anyref)
    (ref.i31 (i32.div_s (i31.get_s (ref.cast (ref i31) (local.get $i))) (i31.get_s (ref.cast (ref i31) (global.get $grid_w))))))

  (func $cell_y (export "cell-y") (param $i i32) (result i32)
    (i31.get_s (ref.cast (ref i31) (call $cell_y_internal (ref.i31 (local.get $i))))))

  (func $in_bounds_QMARK__internal (param $x anyref) (param $y anyref) (result anyref)
    (if (result anyref) (i31.get_s (ref.cast (ref i31) (ref.i31 (i32.ge_s (i31.get_s (ref.cast (ref i31) (local.get $x))) (i31.get_s (ref.cast (ref i31) (ref.i31 (i32.const 0))))))))
        (then (ref.i31 (i32.lt_s (i31.get_s (ref.cast (ref i31) (local.get $x))) (i31.get_s (ref.cast (ref i31) (global.get $grid_w))))))
        (else (ref.i31 (i32.const 0)))))

  (func $in_bounds_QMARK_ (export "in-bounds?") (param $x i32) (param $y i32) (result i32)
    (i31.get_s (ref.cast (ref i31) (call $in_bounds_QMARK__internal (ref.i31 (local.get $x)) (ref.i31 (local.get $y))))))

  (func $make_empty_grid_internal  (result anyref)
    (local $i anyref)
    (local $grid anyref)
    (block (result anyref)
      (local.set $i (ref.i31 (i32.const 0)))
      (local.set $grid (call $empty_vector))
      (loop $loop17 (result anyref)
        (if (result anyref)
      (call $truthy (ref.i31 (i32.ge_s (i31.get_s (ref.cast (ref i31) (local.get $i))) (i31.get_s (ref.cast (ref i31) (global.get $total_cells))))))
      (then (local.get $grid))
      (else (ref.i31 (i32.add (i31.get_s (ref.cast (ref i31) (local.get $i))) (i32.const 1)))
        (call $vector_conj (local.get $grid) (ref.i31 (i32.const 0)))
        (local.set $grid)
        (local.set $i)
        (br $loop17))))))

  (func $make_empty_grid (export "make-empty-grid")  (result i32)
    (i31.get_s (ref.cast (ref i31) (call $make_empty_grid_internal ))))

  (func $make_random_grid_internal  (result anyref)
    (local $i anyref)
    (local $grid anyref)
    (block (result anyref)
      (local.set $i (ref.i31 (i32.const 0)))
      (local.set $grid (call $empty_vector))
      (loop $loop18 (result anyref)
        (if (result anyref)
      (call $truthy (ref.i31 (i32.ge_s (i31.get_s (ref.cast (ref i31) (local.get $i))) (i31.get_s (ref.cast (ref i31) (global.get $total_cells))))))
      (then (local.get $grid))
      (else (ref.i31 (i32.add (i31.get_s (ref.cast (ref i31) (local.get $i))) (i32.const 1)))
        (call $vector_conj (local.get $grid) (if (result anyref)
      (call $truthy (ref.i31 (i32.gt_s (i31.get_s (ref.cast (ref i31) (call $next_random_internal ))) (i31.get_s (ref.cast (ref i31) (ref.i31 (i32.const 45000)))))))
      (then (ref.i31 (i32.const 1)))
      (else (ref.i31 (i32.const 0)))))
        (local.set $grid)
        (local.set $i)
  ...
  (func $make_random_grid (export "make-random-grid")  (result i32)
    (i31.get_s (ref.cast (ref i31) (call $make_random_grid_internal ))))

  (func $grid_get_internal (param $grid anyref) (param $x anyref) (param $y anyref) (result anyref)
    (if (result anyref)
      (call $truthy (call $in_bounds_QMARK__internal (local.get $x) (local.get $y)))
      (then (call $nth_polymorphic (local.get $grid) (i31.get_s (ref.cast (ref i31) (call $cell_index_internal (local.get $x) (local.get $y))))))
      (else (ref.i31 (i32.const 0)))))

  (func $grid_get (export "grid-get") (param $grid i32) (param $x i32) (param $y i32) (result i32)
    (i31.get_s (ref.cast (ref i31) (call $grid_get_internal (ref.i31 (local.get $grid)) (ref.i31 (local.get $x)) (ref.i31 (local.get $y))))))

  (func $cell_alive_QMARK__internal (param $v anyref) (result anyref)
    (ref.i31 (i32.gt_s (i31.get_s (ref.cast (ref i31) (local.get $v))) (i31.get_s (ref.cast (ref i31) (ref.i31 (i32.const 0)))))))

  (func $cell_alive_QMARK_ (export "cell-alive?") (param $v i32) (result i32)
    (i31.get_s (ref.cast (ref i31) (call $cell_alive_QMARK__internal (ref.i31 (local.get $v))))))

  (func $count_neighbors_internal (param $grid anyref) (param $x anyref) (param $y anyref) (result anyref)
    (local $xm anyref)
    (local $xp anyref)
    (local $ym anyref)
    (local $yp anyref)
    (local $n anyref)
    (block (result anyref)
      (local.set $xm (ref.i31 (i32.sub (i31.get_s (ref.cast (ref i31) (local.get $x))) (i32.const 1))))
      (local.set $xp (ref.i31 (i32.add (i31.get_s (ref.cast (ref i31) (local.get $x))) (i32.const 1))))
      (local.set $ym (ref.i31 (i32.sub (i31.get_s (ref.cast (ref i31) (local.get $y))) (i32.const 1))))
      (local.set $yp (ref.i31 (i32.add (i31.get_s (ref.cast (ref i31) (local.get $y))) (i32.const 1))))
      (local.set $n (ref.i31 (i32.const 0)))
      (local.set $n (if (result anyref)
      (call $truthy (call $cell_alive_QMARK__internal (call $grid_get_internal (local.get $grid) (local.get $xm) (local.get $ym))))
      (then (ref.i31 (i32.add (i31.get_s (ref.cast (ref i31) (local.get $n))) (i32.const 1))))
      (else (local.get $n))))
      (local.set $n (if (result anyref)
      (call $truthy (call $cell_alive_QMARK__internal (call $grid_get_internal (local.get $grid) (local.get $x) (local.get $ym))))
      (then (ref.i31 (i32.add (i31.get_s (ref.cast (ref i31) (local.get $n))) (i32.const 1))))
      (else (local.get $n))))
      (local.set $n (if (result anyref)
      (call $truthy (call $cell_alive_QMARK__internal (call $grid_get_internal (local.get $grid) (local.get $xp) (local.get $ym))))
      (then (ref.i31 (i32.add (i31.get_s (ref.cast (ref i31) (local.get $n))) (i32.const 1))))
      (else (local.get $n))))
      (local.set $n (if (result anyref)
      (call $truthy (call $cell_alive_QMARK__internal (call $grid_get_internal (local.get $grid) (local.get $xm) (local.get $y))))
      (then (ref.i31 (i32.add (i31.get_s (ref.cast (ref i31) (local.get $n))) (i32.const 1))))
      (else (local.get $n))))
      (local.set $n (if (result anyref)
      (call $truthy (call $cell_alive_QMARK__internal (call $grid_get_internal (local.get $grid) (local.get $xp) (local.get $y))))
      (then (ref.i31 (i32.add (i31.get_s (ref.cast (ref i31) (local.get $n))) (i32.const 1))))
      (else (local.get $n))))
      (local.set $n (if (result anyref)
      (call $truthy (call $cell_alive_QMARK__internal (call $grid_get_internal (local.get $grid) (local.get $xm) (local.get $yp))))
      (then (ref.i31 (i32.add (i31.get_s (ref.cast (ref i31) (local.get $n))) (i32.const 1))))
      (else (local.get $n))))
      (local.set $n (if (result anyref)
      (call $truthy (call $cell_alive_QMARK__internal (call $grid_get_internal (local.get $grid) (local.get $x) (local.get $yp))))
      (then (ref.i31 (i32.add (i31.get_s (ref.cast (ref i31) (local.get $n))) (i32.const 1))))
      (else (local.get $n))))
      (local.set $n (if (result anyref)
      (call $truthy (call $cell_alive_QMARK__internal (call $grid_get_internal (local.get $grid) (local.get $xp) (local.get $yp))))
      (then (ref.i31 (i32.add (i31.get_s (ref.cast (ref i31) (local.get $n))) (i32.const 1))))
      (else (local.get $n))))
      (local.get $n)))

  (func $count_neighbors (export "count-neighbors") (param $grid i32) (param $x i32) (param $y i32) (result i32)
    (i31.get_s (ref.cast (ref i31) (call $count_neighbors_internal (ref.i31 (local.get $grid)) (ref.i31 (local.get $x)) (ref.i31 (local.get $y))))))

  (func $next_cell_internal (param $grid anyref) (param $i anyref) (result anyref)
    (local $x anyref)
    (local $y anyref)
    (local $nbrs anyref)
    (local $current anyref)
    (local $is_alive anyref)
    (block (result anyref)
      (local.set $x (call $cell_x_internal (local.get $i)))
      (local.set $y (call $cell_y_internal (local.get $i)))
      (local.set $nbrs (call $count_neighbors_internal (local.get $grid) (local.get $x) (local.get $y)))
      (local.set $current (call $nth_polymorphic (local.get $grid) (i31.get_s (ref.cast (ref i31) (local.get $i)))))
      (local.set $is_alive (call $cell_alive_QMARK__internal (local.get $current)))
      (if (result anyref)
      (call $truthy (if (result anyref) (i31.get_s (ref.cast (ref i31) (local.get $is_alive)))
        (then (if (result anyref) (i31.get_s (ref.cast (ref i31) (ref.i31 (call $eq (local.get $nbrs) (ref.i31 (i32.const 2))))))
        (then (ref.i31 (call $eq (local.get $nbrs) (ref.i31 (i32.const 2)))))
        (else (ref.i31 (call $eq (local.get $nbrs) (ref.i31 (i32.const 3)))))))
        (else (ref.i31 (i32.const 0)))))
      (then (if (result anyref)
      (call $truthy (ref.i31 (i32.lt_s (i31.get_s (ref.cast (ref i31) (local.get $current))) (i31.get_s (ref.cast (ref i31) (ref.i31 (i32.const 60)))))))
      (then (ref.i31 (i32.add (i31.get_s (ref.cast (ref i31) (local.get $current))) (i32.const 1))))
      (else (ref.i31 (i32.const 60)))))
      (else (if (result anyref)
      (call $truthy (if (result anyref) (i31.get_s (ref.cast (ref i31) (ref.i31 (i32.eqz (i31.get_s (ref.cast (ref i31) (local.get $is_alive)))))))
        (then (ref.i31 (call $eq (local.get $nbrs) (ref.i31 (i32.const 3)))))
        (else (ref.i31 (i32.const 0)))))
      (then (ref.i31 (i32.const 1)))
      (else (ref.i31 (i32.const 0))))))))

  (func $next_cell (export "next-cell") (param $grid i32) (param $i i32) (result i32)
    (i31.get_s (ref.cast (ref i31) (call $next_cell_internal (ref.i31 (local.get $grid)) (ref.i31 (local.get $i))))))

  (func $next_generation_internal (param $grid anyref) (result anyref)
    (local $i anyref)
    (local $new_grid anyref)
    (block (result anyref)
      (local.set $i (ref.i31 (i32.const 0)))
      (local.set $new_grid (call $empty_vector))
      (loop $loop19 (result anyref)
        (if (result anyref)
      (call $truthy (ref.i31 (i32.ge_s (i31.get_s (ref.cast (ref i31) (local.get $i))) (i31.get_s (ref.cast (ref i31) (global.get $total_cells))))))
      (then (local.get $new_grid))
      (else (ref.i31 (i32.add (i31.get_s (ref.cast (ref i31) (local.get $i))) (i32.const 1)))
        (call $vector_conj (local.get $new_grid) (call $next_cell_internal (local.get $grid) (local.get $i)))
        (local.set $new_grid)
        (local.set $i)
        (br $loop19))))))

  (func $next_generation (export "next-generation") (param $grid i32) (result i32)
    (i31.get_s (ref.cast (ref i31) (call $next_generation_internal (ref.i31 (local.get $grid))))))

  (func $clamp_internal (param $v anyref) (param $lo anyref) (param $hi anyref) (result anyref)
    (if (result anyref)
      (call $truthy (ref.i31 (i32.lt_s (i31.get_s (ref.cast (ref i31) (local.get $v))) (i31.get_s (ref.cast (ref i31) (local.get $lo))))))
      (then (local.get $lo))
      (else (if (result anyref)
      (call $truthy (ref.i31 (i32.gt_s (i31.get_s (ref.cast (ref i31) (local.get $v))) (i31.get_s (ref.cast (ref i31) (local.get $hi))))))
      (then (local.get $hi))
      (else (local.get $v))))))

  (func $clamp (export "clamp") (param $v i32) (param $lo i32) (param $hi i32) (result i32)
    (i31.get_s (ref.cast (ref i31) (call $clamp_internal (ref.i31 (local.get $v)) (ref.i31 (local.get $lo)) (ref.i31 (local.get $hi))))))

  (func $pack_rgb_internal (param $r anyref) (param $g anyref) (param $b anyref) (result anyref)
    (ref.i31 (i32.add (i31.get_s (ref.cast (ref i31) (ref.i31 (i32.mul (i31.get_s (ref.cast (ref i31) (call $clamp_internal (local.get $r) (ref.i31 (i32.const 0)) (ref.i31 (i32.const 255))))) (i31.get_s (ref.cast (ref i31) (ref.i31 (i32.const 65536)))))))) (i31.get_s (ref.cast (ref i31) (ref.i31 (i32.mul (i31.get_s (ref.cast (ref i31) (call $clamp_internal (local.get $g) (ref.i31 (i32.const 0)) (ref.i31 (i32.const 255))))) (i31.get_s (ref.cast (ref i31) (ref.i31 (i32.const 256)))))))))))

  (func $pack_rgb (export "pack-rgb") (param $r i32) (param $g i32) (param $b i32) (result i32)
    (i31.get_s (ref.cast (ref i31) (call $pack_rgb_internal (ref.i31 (local.get $r)) (ref.i31 (local.get $g)) (ref.i31 (local.get $b))))))

  (func $age_>color_internal (param $age anyref) (result anyref)
    (if (result anyref)
      (call $truthy (ref.i31 (call $eq (local.get $age) (ref.i31 (i32.const 1)))))
      (then (call $pack_rgb_internal (ref.i31 (i32.const 100)) (ref.i31 (i32.const 255)) (ref.i31 (i32.const 100))))
      (else (if (result anyref)
      (call $truthy (ref.i31 (i32.le_s (i31.get_s (ref.cast (ref i31) (local.get $age))) (i31.get_s (ref.cast (ref i31) (ref.i31 (i32.const 3)))))))
      (then (call $pack_rgb_internal (ref.i31 (i32.const 40)) (ref.i31 (i32.const 230)) (ref.i31 (i32.const 140))))
      (else (if (result anyref)
      (call $truthy (ref.i31 (i32.le_s (i31.get_s (ref.cast (ref i31) (local.get $age))) (i31.get_s (ref.cast (ref i31) (ref.i31 (i32.const 6)))))))
      (then (call $pack_rgb_internal (ref.i31 (i32.const 0)) (ref.i31 (i32.const 200)) (ref.i31 (i32.const 200))))
      (else (if (result anyref)
      (call $truthy (ref.i31 (i32.le_s (i31.get_s (ref.cast (ref i31) (local.get $age))) (i31.get_s (ref.cast (ref i31) (ref.i31 (i32.const 12)))))))
      (then (call $pack_rgb_internal (ref.i31 (i32.const 0)) (ref.i31 (i32.const 150)) (ref.i31 (i32.const 255))))
      (else (if (result anyref)
      (call $truthy (ref.i31 (i32.le_s (i31.get_s (ref.cast (ref i31) (local.get $age))) (i31.get_s (ref.cast (ref i31) (ref.i31 (i32.const 25)))))))
      (then (call $pack_rgb_internal (ref.i31 (i32.const 80)) (ref.i31 (i32.const 100)) (ref.i31 (i32.const 255))))
      (else (if (result anyref)
      (call $truthy (ref.i31 (i32.le_s (i31.get_s (ref.cast (ref i31) (local.get $age))) (i31.get_s (ref.cast (ref i31) (ref.i31 (i32.const 40)))))))
      (then (call $pack_rgb_internal (ref.i31 (i32.const 130)) (ref.i31 (i32.const 70)) (ref.i31 (i32.const 230))))
      (else (call $pack_rgb_internal (ref.i31 (i32.const 90)) (ref.i31 (i32.const 50)) (ref.i31 (i32.const 160))))))))))))))))

  (func $place_cells_internal (param $grid anyref) (param $cells anyref) (param $ox anyref) (param $oy anyref) (result anyref)
    (local $remaining anyref)
    (local $g anyref)
    (local $cell anyref)
    (local $cx anyref)
    (local $cy anyref)
    (block (result anyref)
      (local.set $remaining (call $seq (local.get $cells)))
      (local.set $g (local.get $grid))
      (loop $loop20 (result anyref)
        (if (result anyref)
      (call $truthy (call $nil_QMARK_ (local.get $remaining)))
      (then (local.get $g))
      (else (block (result anyref)
      (local.set $cell (call $first (local.get $remaining)))
      (local.set $cx (ref.i31 (i32.add (i31.get_s (ref.cast (ref i31) (local.get $ox))) (i31.get_s (ref.cast (ref i31) (call $nth_polymorphic (local.get $cell) (i31.get_s (ref.cast (ref i31) (ref.i31 (i32.const 0))))))))))
      (local.set $cy (ref.i31 (i32.add (i31.get_s (ref.cast (ref i31) (local.get $oy))) (i31.get_s (ref.cast (ref i31) (call $nth_polymorphic (local.get $cell) (i31.get_s (ref.cast (ref i31) (ref.i31 (i32.const 1))))))))))
      (call $rest (local.get $remaining))
        (if (result anyref)
      (call $truthy (call $in_bounds_QMARK__internal (local.get $cx) (local.get $cy)))
      (then (call $assoc (local.get $g) (call $cell_index_internal (local.get $cx) (local.get $cy)) (ref.i31 (i32.const 1))))
      (else (local.get $g)))
        (local.set $g)
        (local.set $remaining)
        (br $loop20)))))))

  (func $place_cells (export "place-cells") (param $grid i32) (param $cells i32) (param $ox i32) (param $oy i32) (result i32)
    (i31.get_s (ref.cast (ref i31) (call $place_cells_internal (ref.i31 (local.get $grid)) (ref.i31 (local.get $cells)) (ref.i31 (local.get $ox)) (ref.i31 (local.get $oy))))))

  (func $get_width_internal  (result anyref)
    (global.get $grid_w))

  (func $get_width (export "get-width")  (result i32)
    (i31.get_s (ref.cast (ref i31) (call $get_width_internal ))))

  (func $get_height_internal  (result anyref)
    (global.get $grid_h))

  (func $get_height (export "get-height")  (result i32)
    (i31.get_s (ref.cast (ref i31) (call $get_height_internal ))))

  (func $init_internal  (result anyref)
    (block (result anyref)
      (call $reset_BANG_ (global.get $state) (call $hash_map_assoc (call $hash_map_assoc (call $hash_map_assoc (call $empty_hash_map) (struct.new $Keyword (i32.const 0)) (call $make_empty_grid_internal )) (struct.new $Keyword (i32.const 1)) (ref.i31 (i32.const 1))) (struct.new $Keyword (i32.const 2)) (ref.i31 (i32.const 0))))
      drop
      (ref.i31 (i32.const 0))))

  (func $init (export "init")  (result i32)
    (i31.get_s (ref.cast (ref i31) (call $init_internal ))))

  (func $fn24 (type $ClosureFunc1) (param $__env anyref) (param $s anyref) (result anyref)
    (local $g anyref)
    (block (result anyref)
      (local.set $g (call $make_empty_grid_internal ))
      (local.set $g (call $place_cells_internal (local.get $g) (global.get $glider_gun) (ref.i31 (i32.const 1)) (ref.i31 (i32.const 2))))
      (local.set $g (call $place_cells_internal (local.get $g) (global.get $pulsar) (ref.i31 (i32.const 55)) (ref.i31 (i32.const 23))))
      (local.set $g (call $place_cells_internal (local.get $g) (global.get $rpentomino) (ref.i31 (i32.const 60)) (ref.i31 (i32.const 8))))
      (local.set $g (call $place_cells_internal (local.get $g) (global.get $lwss) (ref.i31 (i32.const 25)) (ref.i31 (i32.const 50))))
      (local.set $g (call $place_cells_internal (local.get $g) (global.get $glider) (ref.i31 (i32.const 38)) (ref.i31 (i32.const 5))))
      (local.set $g (call $place_cells_internal (local.get $g) (global.get $glider) (ref.i31 (i32.const 44)) (ref.i31 (i32.const 8))))
      (local.set $g (call $place_cells_internal (local.get $g) (global.get $glider) (ref.i31 (i32.const 50)) (ref.i31 (i32.const 5))))
      (call $assoc (call $assoc (local.get $s) (struct.new $Keyword (i32.const 0)) (local.get $g)) (struct.new $Keyword (i32.const 2)) (ref.i31 (i32.const 0)))))

  (func $load_demo_internal  (result anyref)
    (block (result anyref)
      (call $swap_BANG_ (global.get $state) (struct.new $Closure1 (ref.func $fn24) (call $array_new (i32.const 0))))
      drop
      (ref.i31 (i32.const 0))))

  (func $load_demo (export "load-demo")  (result i32)
    (i31.get_s (ref.cast (ref i31) (call $load_demo_internal ))))

  (func $get_pixel_internal (param $i anyref) (result anyref)
    (local $age anyref)
    (block (result anyref)
      (local.set $age (call $nth_polymorphic (call $hash_map_get (call $deref (global.get $state)) (struct.new $Keyword (i32.const 0))) (i31.get_s (ref.cast (ref i31) (local.get $i)))))
      (if (result anyref)
      (call $truthy (ref.i31 (call $eq (local.get $age) (ref.i31 (i32.const 0)))))
      (then (global.get $color_bg))
      (else (call $age_>color_internal (local.get $age))))))

  (func $get_pixel (export "get-pixel") (param $i i32) (result i32)
    (i31.get_s (ref.cast (ref i31) (call $get_pixel_internal (ref.i31 (local.get $i))))))

  (func $fn25 (type $ClosureFunc1) (param $__env anyref) (param $s anyref) (result anyref)
    (call $assoc (call $assoc (local.get $s) (struct.new $Keyword (i32.const 0)) (call $next_generation_internal (call $hash_map_get (local.get $s) (struct.new $Keyword (i32.const 0))))) (struct.new $Keyword (i32.const 2)) (ref.i31 (i32.add (i31.get_s (ref.cast (ref i31) (call $hash_map_get (local.get $s) (struct.new $Keyword (i32.const 2))))) (i32.const 1)))))

  (func $tick_internal  (result anyref)
    (block (result anyref)
      (if (result anyref)
      (call $truthy (call $hash_map_get (call $deref (global.get $state)) (struct.new $Keyword (i32.const 1))))
      (then (ref.null none))
      (else (block (result anyref)
      (call $swap_BANG_ (global.get $state) (struct.new $Closure1 (ref.func $fn25) (call $array_new (i32.const 0)))))))
      drop
      (ref.i31 (i32.const 0))))

  (func $tick (export "tick")  (result i32)
    (i31.get_s (ref.cast (ref i31) (call $tick_internal ))))

  (func $fn26 (type $ClosureFunc1) (param $__env anyref) (param $s anyref) (result anyref)
    (call $assoc (call $assoc (local.get $s) (struct.new $Keyword (i32.const 0)) (call $next_generation_internal (call $hash_map_get (local.get $s) (struct.new $Keyword (i32.const 0))))) (struct.new $Keyword (i32.const 2)) (ref.i31 (i32.add (i31.get_s (ref.cast (ref i31) (call $hash_map_get (local.get $s) (struct.new $Keyword (i32.const 2))))) (i32.const 1)))))

  (func $step_internal  (result anyref)
    (block (result anyref)
      (call $swap_BANG_ (global.get $state) (struct.new $Closure1 (ref.func $fn26) (call $array_new (i32.const 0))))
      drop
      (ref.i31 (i32.const 0))))

  (func $step (export "step")  (result i32)
    (i31.get_s (ref.cast (ref i31) (call $step_internal ))))

  (func $fn27 (type $ClosureFunc1) (param $__env anyref) (param $s anyref) (result anyref)
    (call $assoc (local.get $s) (struct.new $Keyword (i32.const 1)) (ref.i31 (i32.eqz (i31.get_s (ref.cast (ref i31) (call $hash_map_get (local.get $s) (struct.new $Keyword (i32.const 1)))))))))

  (func $toggle_pause_internal  (result anyref)
    (block (result anyref)
      (call $swap_BANG_ (global.get $state) (struct.new $Closure1 (ref.func $fn27) (call $array_new (i32.const 0))))
      drop
      (ref.i31 (i32.const 0))))

  (func $toggle_pause (export "toggle-pause")  (result i32)
    (i31.get_s (ref.cast (ref i31) (call $toggle_pause_internal ))))

  (func $is_paused_internal  (result anyref)
    (if (result anyref)
      (call $truthy (call $hash_map_get (call $deref (global.get $state)) (struct.new $Keyword (i32.const 1))))
      (then (ref.i31 (i32.const 1)))
      (else (ref.i31 (i32.const 0)))))

  (func $is_paused (export "is-paused")  (result i32)
    (i31.get_s (ref.cast (ref i31) (call $is_paused_internal ))))

  (func $get_generation_internal  (result anyref)
    (call $hash_map_get (call $deref (global.get $state)) (struct.new $Keyword (i32.const 2))))

  (func $get_generation (export "get-generation")  (result i32)
    (i31.get_s (ref.cast (ref i31) (call $get_generation_internal ))))

  (func $fn28 (type $ClosureFunc2) (param $__env anyref) (param $acc anyref) (param $cell anyref) (result anyref)
    (if (result anyref)
      (call $truthy (call $cell_alive_QMARK__internal (local.get $cell)))
      (then (ref.i31 (i32.add (i31.get_s (ref.cast (ref i31) (local.get $acc))) (i32.const 1))))
      (else (local.get $acc))))

  (func $get_population_internal  (result anyref)
    (call $reduce (struct.new $Closure2 (ref.func $fn28) (call $array_new (i32.const 0))) (ref.i31 (i32.const 0)) (call $hash_map_get (call $deref (global.get $state)) (struct.new $Keyword (i32.const 0)))))

  (func $get_population (export "get-population")  (result i32)
    (i31.get_s (ref.cast (ref i31) (call $get_population_internal ))))

  (func $is_alive_at_internal (param $x anyref) (param $y anyref) (result anyref)
    (if (result anyref)
      (call $truthy (if (result anyref) (i31.get_s (ref.cast (ref i31) (call $in_bounds_QMARK__internal (local.get $x) (local.get $y))))
        (then (call $cell_alive_QMARK__internal (call $nth_polymorphic (call $hash_map_get (call $deref (global.get $state)) (struct.new $Keyword (i32.const 0))) (i31.get_s (ref.cast (ref i31) (call $cell_index_internal (local.get $x) (local.get $y)))))))
        (else (ref.i31 (i32.const 0)))))
      (then (ref.i31 (i32.const 1)))
      (else (ref.i31 (i32.const 0)))))

  (func $is_alive_at (export "is-alive-at") (param $x i32) (param $y i32) (result i32)
    (i31.get_s (ref.cast (ref i31) (call $is_alive_at_internal (ref.i31 (local.get $x)) (ref.i31 (local.get $y))))))

  (func $closure29 (type $ClosureFunc1) (param $__env anyref) (param $s anyref) (result anyref)
    (call $assoc (local.get $s) (struct.new $Keyword (i32.const 0)) (call $assoc (call $hash_map_get (local.get $s) (struct.new $Keyword (i32.const 0))) (call $cell_index_internal (call $array_get (local.get $__env) (i32.const 0)) (call $array_get (local.get $__env) (i32.const 1))) (ref.i31 (i32.const 1)))))

  (func $set_alive_internal (param $x anyref) (param $y anyref) (result anyref)
    (local $__tmp_env anyref)
    (block (result anyref)
      (if (result anyref)
      (call $truthy (call $in_bounds_QMARK__internal (local.get $x) (local.get $y)))
      (then (block (result anyref)
      (call $swap_BANG_ (global.get $state) (struct.new $Closure1 (ref.func $closure29) (block (result anyref)
        (local.set $__tmp_env (call $array_new (i32.const 2)))
        (call $array_set (local.get $__tmp_env) (i32.const 0) (local.get $x))
        (call $array_set (local.get $__tmp_env) (i32.const 1) (local.get $y))
        (local.get $__tmp_env))))))
      (else (ref.null none)))
      drop
      (ref.i31 (i32.const 0))))

  (func $set_alive (export "set-alive") (param $x i32) (param $y i32) (result i32)
    (i31.get_s (ref.cast (ref i31) (call $set_alive_internal (ref.i31 (local.get $x)) (ref.i31 (local.get $y))))))

  (func $closure30 (type $ClosureFunc1) (param $__env anyref) (param $s anyref) (result anyref)
    (call $assoc (local.get $s) (struct.new $Keyword (i32.const 0)) (call $assoc (call $hash_map_get (local.get $s) (struct.new $Keyword (i32.const 0))) (call $cell_index_internal (call $array_get (local.get $__env) (i32.const 0)) (call $array_get (local.get $__env) (i32.const 1))) (ref.i31 (i32.const 0)))))

  (func $set_dead_internal (param $x anyref) (param $y anyref) (result anyref)
    (local $__tmp_env anyref)
    (block (result anyref)
      (if (result anyref)
      (call $truthy (call $in_bounds_QMARK__internal (local.get $x) (local.get $y)))
      (then (block (result anyref)
      (call $swap_BANG_ (global.get $state) (struct.new $Closure1 (ref.func $closure30) (block (result anyref)
        (local.set $__tmp_env (call $array_new (i32.const 2)))
        (call $array_set (local.get $__tmp_env) (i32.const 0) (local.get $x))
        (call $array_set (local.get $__tmp_env) (i32.const 1) (local.get $y))
        (local.get $__tmp_env))))))
  ...
  (func $set_dead (export "set-dead") (param $x i32) (param $y i32) (result i32)
    (i31.get_s (ref.cast (ref i31) (call $set_dead_internal (ref.i31 (local.get $x)) (ref.i31 (local.get $y))))))

  (func $fn31 (type $ClosureFunc1) (param $__env anyref) (param $s anyref) (result anyref)
    (call $assoc (call $assoc (local.get $s) (struct.new $Keyword (i32.const 0)) (call $make_empty_grid_internal )) (struct.new $Keyword (i32.const 2)) (ref.i31 (i32.const 0))))

  (func $clear_grid_internal  (result anyref)
    (block (result anyref)
      (call $swap_BANG_ (global.get $state) (struct.new $Closure1 (ref.func $fn31) (call $array_new (i32.const 0))))
      drop
      (ref.i31 (i32.const 0))))

  (func $clear_grid (export "clear-grid")  (result i32)
    (i31.get_s (ref.cast (ref i31) (call $clear_grid_internal ))))

  (func $fn32 (type $ClosureFunc1) (param $__env anyref) (param $s anyref) (result anyref)
    (call $assoc (call $assoc (local.get $s) (struct.new $Keyword (i32.const 0)) (call $make_random_grid_internal )) (struct.new $Keyword (i32.const 2)) (ref.i31 (i32.const 0))))

  (func $randomize_internal  (result anyref)
    (block (result anyref)
      (call $swap_BANG_ (global.get $state) (struct.new $Closure1 (ref.func $fn32) (call $array_new (i32.const 0))))
      drop
      (ref.i31 (i32.const 0))))

  (func $randomize (export "randomize")  (result i32)
    (i31.get_s (ref.cast (ref i31) (call $randomize_internal ))))

  (func $seed_rng_internal (param $seed anyref) (result anyref)
    (block (result anyref)
      (call $reset_BANG_ (global.get $rng) (if (result anyref)
      (call $truthy (ref.i31 (call $eq (local.get $seed) (ref.i31 (i32.const 0)))))
      (then (ref.i31 (i32.const 1)))
      (else (local.get $seed))))
      drop
      (ref.i31 (i32.const 0))))

  (func $seed_rng (export "seed-rng") (param $seed i32) (result i32)
    (i31.get_s (ref.cast (ref i31) (call $seed_rng_internal (ref.i31 (local.get $seed))))))

  (func $fn33 (type $ClosureFunc1) (param $__env anyref) (param $s anyref) (result anyref)
    (call $assoc (local.get $s) (struct.new $Keyword (i32.const 0)) (call $place_cells_internal (call $hash_map_get (local.get $s) (struct.new $Keyword (i32.const 0))) (global.get $glider) (ref.i31 (i32.sub (i31.get_s (ref.cast (ref i31) (ref.i31 (i32.div_s (i31.get_s (ref.cast (ref i31) (global.get $grid_w))) (i31.get_s (ref.cast (ref i31) (ref.i31 (i32.const 2)))))))) (i31.get_s (ref.cast (ref i31) (ref.i31 (i32.const 1)))))) (ref.i31 (i32.sub (i31.get_s (ref.cast (ref i31) (ref.i31 (i32.div_s (i31.get_s (ref.cast (ref i31) (global.get $grid_h))) (i31.get_s (ref.cast (ref i31) (ref.i31 (i32.const 2)))))))) (i31.get_s (ref.cast (ref i31) (ref.i31 (i32.const 1)))))))))

  (func $add_glider_internal  (result anyref)
    (block (result anyref)
      (call $swap_BANG_ (global.get $state) (struct.new $Closure1 (ref.func $fn33) (call $array_new (i32.const 0))))
      drop
      (ref.i31 (i32.const 0))))

  (func $add_glider (export "add-glider")  (result i32)
    (i31.get_s (ref.cast (ref i31) (call $add_glider_internal ))))

  (func $fn34 (type $ClosureFunc1) (param $__env anyref) (param $s anyref) (result anyref)
    (call $assoc (local.get $s) (struct.new $Keyword (i32.const 0)) (call $place_cells_internal (call $hash_map_get (local.get $s) (struct.new $Keyword (i32.const 0))) (global.get $pulsar) (ref.i31 (i32.sub (i31.get_s (ref.cast (ref i31) (ref.i31 (i32.div_s (i31.get_s (ref.cast (ref i31) (global.get $grid_w))) (i31.get_s (ref.cast (ref i31) (ref.i31 (i32.const 2)))))))) (i31.get_s (ref.cast (ref i31) (ref.i31 (i32.const 6)))))) (ref.i31 (i32.sub (i31.get_s (ref.cast (ref i31) (ref.i31 (i32.div_s (i31.get_s (ref.cast (ref i31) (global.get $grid_h))) (i31.get_s (ref.cast (ref i31) (ref.i31 (i32.const 2)))))))) (i31.get_s (ref.cast (ref i31) (ref.i31 (i32.const 6)))))))))

  (func $add_pulsar_internal  (result anyref)
    (block (result anyref)
      (call $swap_BANG_ (global.get $state) (struct.new $Closure1 (ref.func $fn34) (call $array_new (i32.const 0))))
      drop
      (ref.i31 (i32.const 0))))

  (func $add_pulsar (export "add-pulsar")  (result i32)
    (i31.get_s (ref.cast (ref i31) (call $add_pulsar_internal ))))

  (func $fn35 (type $ClosureFunc1) (param $__env anyref) (param $s anyref) (result anyref)
    (call $assoc (local.get $s) (struct.new $Keyword (i32.const 0)) (call $place_cells_internal (call $hash_map_get (local.get $s) (struct.new $Keyword (i32.const 0))) (global.get $glider_gun) (ref.i31 (i32.const 2)) (ref.i31 (i32.sub (i31.get_s (ref.cast (ref i31) (ref.i31 (i32.div_s (i31.get_s (ref.cast (ref i31) (global.get $grid_h))) (i31.get_s (ref.cast (ref i31) (ref.i31 (i32.const 2)))))))) (i31.get_s (ref.cast (ref i31) (ref.i31 (i32.const 4)))))))))

  (func $add_gun_internal  (result anyref)
    (block (result anyref)
      (call $swap_BANG_ (global.get $state) (struct.new $Closure1 (ref.func $fn35) (call $array_new (i32.const 0))))
      drop
      (ref.i31 (i32.const 0))))

  (func $add_gun (export "add-gun")  (result i32)
    (i31.get_s (ref.cast (ref i31) (call $add_gun_internal ))))

  (func $fn36 (type $ClosureFunc1) (param $__env anyref) (param $s anyref) (result anyref)
    (call $assoc (local.get $s) (struct.new $Keyword (i32.const 0)) (call $place_cells_internal (call $hash_map_get (local.get $s) (struct.new $Keyword (i32.const 0))) (global.get $rpentomino) (ref.i31 (i32.div_s (i31.get_s (ref.cast (ref i31) (global.get $grid_w))) (i31.get_s (ref.cast (ref i31) (ref.i31 (i32.const 2)))))) (ref.i31 (i32.div_s (i31.get_s (ref.cast (ref i31) (global.get $grid_h))) (i31.get_s (ref.cast (ref i31) (ref.i31 (i32.const 2)))))))))

  (func $add_rpentomino_internal  (result anyref)
    (block (result anyref)
      (call $swap_BANG_ (global.get $state) (struct.new $Closure1 (ref.func $fn36) (call $array_new (i32.const 0))))
      drop
      (ref.i31 (i32.const 0))))

  (func $add_rpentomino (export "add-rpentomino")  (result i32)
    (i31.get_s (ref.cast (ref i31) (call $add_rpentomino_internal ))))

  (func $test_life_internal  (result anyref)
    (block (result anyref)
      (call $seed_rng_internal (ref.i31 (i32.const 42)))
      drop
      (call $init_internal )
      drop
      (call $set_alive_internal (ref.i31 (i32.const 5)) (ref.i31 (i32.const 5)))
      drop
      (call $set_alive_internal (ref.i31 (i32.const 6)) (ref.i31 (i32.const 5)))
      drop
      (call $set_alive_internal (ref.i31 (i32.const 7)) (ref.i31 (i32.const 5)))
      drop
      (call $step_internal )
      drop
      (if (result anyref)
      (call $truthy (if (result anyref) (i31.get_s (ref.cast (ref i31) (ref.i31 (call $eq (call $is_alive_at_internal (ref.i31 (i32.const 6)) (ref.i31 (i32.const 4))) (ref.i31 (i32.const 1))))))
        (then (ref.i31 (call $eq (call $is_alive_at_internal (ref.i31 (i32.const 6)) (ref.i31 (i32.const 5))) (ref.i31 (i32.const 1)))))
        (else (ref.i31 (i32.const 0)))))
      (then (ref.i31 (i32.const 0)))
      (else (ref.i31 (i32.const 1))))))

  (func $test_life (export "test-life")  (result i32)
    (i31.get_s (ref.cast (ref i31) (call $test_life_internal ))))
  ...
  (func $start
    ...
    drop
    (block (result anyref) (global.set $grid_w (ref.i31 (i32.const 80))) (ref.null none))
    drop
    (block (result anyref) (global.set $grid_h (ref.i31 (i32.const 60))) (ref.null none))
    drop
    (block (result anyref) (global.set $total_cells (ref.i31 (i32.const 4800))) (ref.null none))
    drop
    (block (result anyref) (global.set $color_bg (ref.i31 (i32.const 856343))) (ref.null none))
    drop
    (block (result anyref) (global.set $state (call $atom (ref.null none))) (ref.null none))
    drop
    (block (result anyref) (global.set $rng (call $atom (ref.i31 (i32.const 42)))) (ref.null none))
    drop
    (block (result anyref) (global.set $glider (call $vector_conj (call $vector_conj (call $vector_conj (call $vector_conj (call $vector_conj (call $empty_vector) (call $vector_conj (call $vector_conj (call $empty_vector) (ref.i31 (i32.const 1))) (ref.i31 (i32.const 0)))) (call $vector_conj (call $vector_conj (call $empty_vector) (ref.i31 (i32.const 2))) (ref.i31 (i32.const 1)))) (call $vector_conj (call $vector_conj (call $empty_vector) (ref.i31 (i32.const 0))) (ref.i31 (i32.const 2)))) (call $vector_conj (call $vector_conj (call $empty_vector) (ref.i31 (i32.const 1))) (ref.i31 (i32.const 2)))) (call $vector_conj (call $vector_conj (call $empty_vector) (ref.i31 (i32.const 2))) (ref.i31 (i32.const 2))))) (ref.null none))
    drop
    (block (result anyref) (global.set $rpentomino (call $vector_conj (call $vector_conj (call $vector_conj (call $vector_conj (call $vector_conj (call $empty_vector) (call $vector_conj (call $vector_conj (call $empty_vector) (ref.i31 (i32.const 1))) (ref.i31 (i32.const 0)))) (call $vector_conj (call $vector_conj (call $empty_vector) (ref.i31 (i32.const 2))) (ref.i31 (i32.const 0)))) (call $vector_conj (call $vector_conj (call $empty_vector) (ref.i31 (i32.const 0))) (ref.i31 (i32.const 1)))) (call $vector_conj (call $vector_conj (call $empty_vector) (ref.i31 (i32.const 1))) (ref.i31 (i32.const 1)))) (call $vector_conj (call $vector_conj (call $empty_vector) (ref.i31 (i32.const 1))) (ref.i31 (i32.const 2))))) (ref.null none))
    drop
    (block (result anyref) (global.set $lwss (call $vector_conj (call $vector_conj (call $vector_conj (call $vector_conj (call $vector_conj (call $vector_conj (call $vector_conj (call $vector_conj (call $vector_conj (call $empty_vector) (call $vector_conj (call $vector_conj (call $empty_vector) (ref.i31 (i32.const 1))) (ref.i31 (i32.const 0)))) (call $vector_conj (call $vector_conj (call $empty_vector) (ref.i31 (i32.const 4))) (ref.i31 (i32.const 0)))) (call $vector_conj (call $vector_conj (call $empty_vector) (ref.i31 (i32.const 0))) (ref.i31 (i32.const 1)))) (call $vector_conj (call $vector_conj (call $empty_vector) (ref.i31 (i32.const 0))) (ref.i31 (i32.const 2)))) (call $vector_conj (call $vector_conj (call $empty_vector) (ref.i31 (i32.const 4))) (ref.i31 (i32.const 2)))) (call $vector_conj (call $vector_conj (call $empty_vector) (ref.i31 (i32.const 0))) (ref.i31 (i32.const 3)))) (call $vector_conj (call $vector_conj (call $empty_vector) (ref.i31 (i32.const 1))) (ref.i31 (i32.const 3)))) (call $vector_conj (call $vector_conj (call $empty_vector) (ref.i31 (i32.const 2))) (ref.i31 (i32.const 3)))) (call $vector_conj (call $vector_conj (call $empty_vector) (ref.i31 (i32.const 3))) (ref.i31 (i32.const 3))))) (ref.null none))
    drop
    (block (result anyref) (global.set $pulsar (call $vector_conj (call $vector_conj (call $vector_conj (call $vector_conj (call $vector_conj (call $vector_conj (call $vector_conj (call $vector_conj (call $vector_conj (call $vector_conj (call $vector_conj (call $vector_conj (call $vector_conj (call $vector_conj (call $vector_conj (call $vector_conj (call $vector_conj (call $vector_conj (call $vector_conj (call $vector_conj (call $vector_conj (call $vector_conj (call $vector_conj (call $vector_conj (call $vector_conj (call $vector_conj (call $vector_conj (call $vector_conj (call $vector_conj (call $vector_conj (call $vector_conj (call $vector_conj (call $vector_conj (call $vector_conj (call $vector_conj (call $vector_conj (call $vector_conj (call $vector_conj (call $vector_conj (call $vector_conj (call $vector_conj (call $vector_conj (call $vector_conj (call $vector_conj (call $vector_conj (call $vector_conj (call $vector_conj (call $vector_conj (call $empty_vector) (call $vector_conj (call $vector_conj (call $empty_vector) (ref.i31 (i32.const 2))) (ref.i31 (i32.const 0)))) (call $vector_conj (call $vector_conj (call $empty_vector) (ref.i31 (i32.const 3))) (ref.i31 (i32.const 0)))) (call $vector_conj (call $vector_conj (call $empty_vector) (ref.i31 (i32.const 4))) (ref.i31 (i32.const 0)))) (call $vector_conj (call $vector_conj (call $empty_vector) (ref.i31 (i32.const 8))) (ref.i31 (i32.const 0)))) (call $vector_conj (call $vector_conj (call $empty_vector) (ref.i31 (i32.const 9))) (ref.i31 (i32.const 0)))) (call $vector_conj (call $vector_conj (call $empty_vector) (ref.i31 (i32.const 10))) (ref.i31 (i32.const 0)))) (call $vector_conj (call $vector_conj (call $empty_vector) (ref.i31 (i32.const 0))) (ref.i31 (i32.const 2)))) (call $vector_conj (call $vector_conj (call $empty_vector) (ref.i31 (i32.const 5))) (ref.i31 (i32.const 2)))) (call $vector_conj (call $vector_conj (call $empty_vector) (ref.i31 (i32.const 7))) (ref.i31 (i32.const 2)))) (call $vector_conj (call $vector_conj (call $empty_vector) (ref.i31 (i32.const 12))) (ref.i31 (i32.const 2)))) (call $vector_conj (call $vector_conj (call $empty_vector) (ref.i31 (i32.const 0))) (ref.i31 (i32.const 3)))) (call $vector_conj (call $vector_conj (call $empty_vector) (ref.i31 (i32.const 5))) (ref.i31 (i32.const 3)))) (call $vector_conj (call $vector_conj (call $empty_vector) (ref.i31 (i32.const 7))) (ref.i31 (i32.const 3)))) (call $vector_conj (call $vector_conj (call $empty_vector) (ref.i31 (i32.const 12))) (ref.i31 (i32.const 3)))) (call $vector_conj (call $vector_conj (call $empty_vector) (ref.i31 (i32.const 0))) (ref.i31 (i32.const 4)))) (call $vector_conj (call $vector_conj (call $empty_vector) (ref.i31 (i32.const 5))) (ref.i31 (i32.const 4)))) (call $vector_conj (call $vector_conj (call $empty_vector) (ref.i31 (i32.const 7))) (ref.i31 (i32.const 4)))) (call $vector_conj (call $vector_conj (call $empty_vector) (ref.i31 (i32.const 12))) (ref.i31 (i32.const 4)))) (call $vector_conj (call $vector_conj (call $empty_vector) (ref.i31 (i32.const 2))) (ref.i31 (i32.const 5)))) (call $vector_conj (call $vector_conj (call $empty_vector) (ref.i31 (i32.const 3))) (ref.i31 (i32.const 5)))) (call $vector_conj (call $vector_conj (call $empty_vector) (ref.i31 (i32.const 4))) (ref.i31 (i32.const 5)))) (call $vector_conj (call $vector_conj (call $empty_vector) (ref.i31 (i32.const 8))) (ref.i31 (i32.const 5)))) (call $vector_conj (call $vector_conj (call $empty_vector) (ref.i31 (i32.const 9))) (ref.i31 (i32.const 5)))) (call $vector_conj (call $vector_conj (call $empty_vector) (ref.i31 (i32.const 10))) (ref.i31 (i32.const 5)))) (call $vector_conj (call $vector_conj (call $empty_vector) (ref.i31 (i32.const 2))) (ref.i31 (i32.const 7)))) (call $vector_conj (call $vector_conj (call $empty_vector) (ref.i31 (i32.const 3))) (ref.i31 (i32.const 7)))) (call $vector_conj (call $vector_conj (call $empty_vector) (ref.i31 (i32.const 4))) (ref.i31 (i32.const 7)))) (call $vector_conj (call $vector_conj (call $empty_vector) (ref.i31 (i32.const 8))) (ref.i31 (i32.const 7)))) (call $vector_conj (call $vector_conj (call $empty_vector) (ref.i31 (i32.const 9))) (ref.i31 (i32.const 7)))) (call $vector_conj (call $vector_conj (call $empty_vector) (ref.i31 (i32.const 10))) (ref.i31 (i32.const 7)))) (call $vector_conj (call $vector_conj (call $empty_vector) (ref.i31 (i32.const 0))) (ref.i31 (i32.const 8)))) (call $vector_conj (call $vector_conj (call $empty_vector) (ref.i31 (i32.const 5))) (ref.i31 (i32.const 8)))) (call $vector_conj (call $vector_conj (call $empty_vector) (ref.i31 (i32.const 7))) (ref.i31 (i32.const 8)))) (call $vector_conj (call $vector_conj (call $empty_vector) (ref.i31 (i32.const 12))) (ref.i31 (i32.const 8)))) (call $vector_conj (call $vector_conj (call $empty_vector) (ref.i31 (i32.const 0))) (ref.i31 (i32.const 9)))) (call $vector_conj (call $vector_conj (call $empty_vector) (ref.i31 (i32.const 5))) (ref.i31 (i32.const 9)))) (call $vector_conj (call $vector_conj (call $empty_vector) (ref.i31 (i32.const 7))) (ref.i31 (i32.const 9)))) (call $vector_conj (call $vector_conj (call $empty_vector) (ref.i31 (i32.const 12))) (ref.i31 (i32.const 9)))) (call $vector_conj (call $vector_conj (call $empty_vector) (ref.i31 (i32.const 0))) (ref.i31 (i32.const 10)))) (call $vector_conj (call $vector_conj (call $empty_vector) (ref.i31 (i32.const 5))) (ref.i31 (i32.const 10)))) (call $vector_conj (call $vector_conj (call $empty_vector) (ref.i31 (i32.const 7))) (ref.i31 (i32.const 10)))) (call $vector_conj (call $vector_conj (call $empty_vector) (ref.i31 (i32.const 12))) (ref.i31 (i32.const 10)))) (call $vector_conj (call $vector_conj (call $empty_vector) (ref.i31 (i32.const 2))) (ref.i31 (i32.const 12)))) (call $vector_conj (call $vector_conj (call $empty_vector) (ref.i31 (i32.const 3))) (ref.i31 (i32.const 12)))) (call $vector_conj (call $vector_conj (call $empty_vector) (ref.i31 (i32.const 4))) (ref.i31 (i32.const 12)))) (call $vector_conj (call $vector_conj (call $empty_vector) (ref.i31 (i32.const 8))) (ref.i31 (i32.const 12)))) (call $vector_conj (call $vector_conj (call $empty_vector) (ref.i31 (i32.const 9))) (ref.i31 (i32.const 12)))) (call $vector_conj (call $vector_conj (call $empty_vector) (ref.i31 (i32.const 10))) (ref.i31 (i32.const 12))))) (ref.null none))
    drop
    (block (result anyref) (global.set $glider_gun (call $vector_conj (call $vector_conj (call $vector_conj (call $vector_conj (call $vector_conj (call $vector_conj (call $vector_conj (call $vector_conj (call $vector_conj (call $vector_conj (call $vector_conj (call $vector_conj (call $vector_conj (call $vector_conj (call $vector_conj (call $vector_conj (call $vector_conj (call $vector_conj (call $vector_conj (call $vector_conj (call $vector_conj (call $vector_conj (call $vector_conj (call $vector_conj (call $vector_conj (call $vector_conj (call $vector_conj (call $vector_conj (call $vector_conj (call $vector_conj (call $vector_conj (call $vector_conj (call $vector_conj (call $vector_conj (call $vector_conj (call $vector_conj (call $empty_vector) (call $vector_conj (call $vector_conj (call $empty_vector) (ref.i31 (i32.const 24))) (ref.i31 (i32.const 0)))) (call $vector_conj (call $vector_conj (call $empty_vector) (ref.i31 (i32.const 22))) (ref.i31 (i32.const 1)))) (call $vector_conj (call $vector_conj (call $empty_vector) (ref.i31 (i32.const 24))) (ref.i31 (i32.const 1)))) (call $vector_conj (call $vector_conj (call $empty_vector) (ref.i31 (i32.const 12))) (ref.i31 (i32.const 2)))) (call $vector_conj (call $vector_conj (call $empty_vector) (ref.i31 (i32.const 13))) (ref.i31 (i32.const 2)))) (call $vector_conj (call $vector_conj (call $empty_vector) (ref.i31 (i32.const 20))) (ref.i31 (i32.const 2)))) (call $vector_conj (call $vector_conj (call $empty_vector) (ref.i31 (i32.const 21))) (ref.i31 (i32.const 2)))) (call $vector_conj (call $vector_conj (call $empty_vector) (ref.i31 (i32.const 34))) (ref.i31 (i32.const 2)))) (call $vector_conj (call $vector_conj (call $empty_vector) (ref.i31 (i32.const 35))) (ref.i31 (i32.const 2)))) (call $vector_conj (call $vector_conj (call $empty_vector) (ref.i31 (i32.const 11))) (ref.i31 (i32.const 3)))) (call $vector_conj (call $vector_conj (call $empty_vector) (ref.i31 (i32.const 15))) (ref.i31 (i32.const 3)))) (call $vector_conj (call $vector_conj (call $empty_vector) (ref.i31 (i32.const 20))) (ref.i31 (i32.const 3)))) (call $vector_conj (call $vector_conj (call $empty_vector) (ref.i31 (i32.const 21))) (ref.i31 (i32.const 3)))) (call $vector_conj (call $vector_conj (call $empty_vector) (ref.i31 (i32.const 34))) (ref.i31 (i32.const 3)))) (call $vector_conj (call $vector_conj (call $empty_vector) (ref.i31 (i32.const 35))) (ref.i31 (i32.const 3)))) (call $vector_conj (call $vector_conj (call $empty_vector) (ref.i31 (i32.const 0))) (ref.i31 (i32.const 4)))) (call $vector_conj (call $vector_conj (call $empty_vector) (ref.i31 (i32.const 1))) (ref.i31 (i32.const 4)))) (call $vector_conj (call $vector_conj (call $empty_vector) (ref.i31 (i32.const 10))) (ref.i31 (i32.const 4)))) (call $vector_conj (call $vector_conj (call $empty_vector) (ref.i31 (i32.const 16))) (ref.i31 (i32.const 4)))) (call $vector_conj (call $vector_conj (call $empty_vector) (ref.i31 (i32.const 20))) (ref.i31 (i32.const 4)))) (call $vector_conj (call $vector_conj (call $empty_vector) (ref.i31 (i32.const 21))) (ref.i31 (i32.const 4)))) (call $vector_conj (call $vector_conj (call $empty_vector) (ref.i31 (i32.const 0))) (ref.i31 (i32.const 5)))) (call $vector_conj (call $vector_conj (call $empty_vector) (ref.i31 (i32.const 1))) (ref.i31 (i32.const 5)))) (call $vector_conj (call $vector_conj (call $empty_vector) (ref.i31 (i32.const 10))) (ref.i31 (i32.const 5)))) (call $vector_conj (call $vector_conj (call $empty_vector) (ref.i31 (i32.const 14))) (ref.i31 (i32.const 5)))) (call $vector_conj (call $vector_conj (call $empty_vector) (ref.i31 (i32.const 16))) (ref.i31 (i32.const 5)))) (call $vector_conj (call $vector_conj (call $empty_vector) (ref.i31 (i32.const 17))) (ref.i31 (i32.const 5)))) (call $vector_conj (call $vector_conj (call $empty_vector) (ref.i31 (i32.const 22))) (ref.i31 (i32.const 5)))) (call $vector_conj (call $vector_conj (call $empty_vector) (ref.i31 (i32.const 24))) (ref.i31 (i32.const 5)))) (call $vector_conj (call $vector_conj (call $empty_vector) (ref.i31 (i32.const 10))) (ref.i31 (i32.const 6)))) (call $vector_conj (call $vector_conj (call $empty_vector) (ref.i31 (i32.const 16))) (ref.i31 (i32.const 6)))) (call $vector_conj (call $vector_conj (call $empty_vector) (ref.i31 (i32.const 24))) (ref.i31 (i32.const 6)))) (call $vector_conj (call $vector_conj (call $empty_vector) (ref.i31 (i32.const 11))) (ref.i31 (i32.const 7)))) (call $vector_conj (call $vector_conj (call $empty_vector) (ref.i31 (i32.const 15))) (ref.i31 (i32.const 7)))) (call $vector_conj (call $vector_conj (call $empty_vector) (ref.i31 (i32.const 12))) (ref.i31 (i32.const 8)))) (call $vector_conj (call $vector_conj (call $empty_vector) (ref.i31 (i32.const 13))) (ref.i31 (i32.const 8))))) (ref.null none))
    drop)
  (start $start)
)
